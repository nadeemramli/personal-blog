---
title: "Part 4.1 — High-Risk Plays"
draft: false
tags:
  - rich
  - financial-system
...
>   - **Part 4.1 (this article):** [[Part 4.1 - High-Risk Plays|High-Risk Plays]]
> ----

## Table of Contents

- [The Innovation Fund discipline (recap)](#the-innovation-fund-discipline-recap)
- [Play 1: The cashback / cashflow house](#play-1-the-cashback--cashflow-house)
- [Play 2: Trading and crypto](#play-2-trading-and-crypto)
- [Play 3: Profitable businesses (not cafes)](#play-3-profitable-businesses-not-cafes)
- [The failure modes that recur across all three plays](#the-failure-modes-that-recur-across-all-three-plays)
- [Discipline beats optimisation: closing the series](#discipline-beats-optimisation-closing-the-series)
...
> [!important] Read this before any of the plays below
> The Innovation Fund only earns its name if Buckets 1-4 and 5a are on par per [[Part 3.0 - On Par by Age|Part 3.0]]. ==If they're not, none of the plays in this article apply to you yet. Stop reading and go finish the sequence==. The reason most retail readers blow up on a "high-risk play" is that they ran the play before the system underneath was in place. The system is the licence; the play is what the licence lets you do.

---

## The Innovation Fund discipline (recap)

From [[Part 1.1 - The Five Buckets|Part 1.1]], the rules for Bucket 5b:
...
1. **Check your bucket on-par status.** Are Buckets 1-4 and 5a at target per [[Part 3.0 - On Par by Age|Part 3.0]]? If no, ==you do not have a high-risk play yet. Finish the sequence first.==
...
5. **Re-read [[Part 1.0 - Allocation The Sankey Mindset|Part 1.0]] once a year.** The whole system collapses if Behavior × Surplus drops to zero. The first article is the part that decays the fastest if you stop maintaining it.

## Sources & references

- [[Part 1.0 - Allocation The Sankey Mindset|Multiplying Money 101 — Part 1.0]] through [[Part 4.0 - The Risk Ladder|Part 4.0]] — the system this article rests on.
- [[Part 1.0 - What Income Actually Is|Income 101 — Part 1.0]] and [[Part 4.0 - Stacking Economies and Designing Your Life|Part 4.0]] — the income side; the Build economy maps onto Play 3.
- [[Financial Freedom Is a Coordinate, Not a Number]] — the Kelly Criterion split between Compounding Baseline and Innovation Fund.
- Bill Perkins, *Die With Zero* (2020) — the "agency, not accumulation" argument that closes this article.
- Ed Thorp / William Poundstone, *Fortune's Formula* (2005) — Kelly Criterion mechanics for sizing Bucket 5b positions.
- *Don't Be an Ambitious Bum* (this site, forthcoming series) — calculated risk and the difference between deliberate and accidental risk-taking.
- Bank Negara Malaysia, [residential property market reports](https://www.bnm.gov.my/) — for verifying Play 1 valuation realism.
- Bursa Malaysia / SC Malaysia, [retail investor education](https://www.bursamalaysia.com/) — for the regulatory framing on Play 2.
