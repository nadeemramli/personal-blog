---
title: Part 1.1 — The Four Attributes of a Good Job
draft: false
tags:
  - rich
  - income
...
- [The thesis: a good job is a portfolio of four attributes](#the-thesis-a-good-job-is-a-portfolio-of-four-attributes)
- [Attribute 1: flexibility](#attribute-1-flexibility)
- [Attribute 2: leverage](#attribute-2-leverage)
- [Attribute 3: uniqueness vs top-1% vs mechanical](#attribute-3-uniqueness-vs-top-1-vs-mechanical)
- [Attribute 4: a living industry, not a dying one](#attribute-4-a-living-industry-not-a-dying-one)
- [The scorecard: how to actually grade a job](#the-scorecard-how-to-actually-grade-a-job)
...
> [!important] Why four attributes, and why these four?
...
| Level                                | What it looks like                                                       | Real flexibility?                                                                                |
| ------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| **Five days in office, fixed hours** | Standard pre-2020 corporate                                              | None. Your day is the company's day.                                                             |
| **Hybrid (2–3 days in)**             | The 2024–2026 compromise                                                 | Partial. You get some midweek depth, but Mondays, Fridays, and the commute still belong to them. |
| **Remote-but-monitored**             | "Work from home" with screen tracking, instant-response Slack culture    | Almost none. You traded the commute for surveillance.                                            |
| **Remote-default, async-respected**  | Output measured by work shipped, not hours present; deep blocks possible | Real. The day is yours; the work has to land.                                                    |
...
- It lets you train at the right time of day (see the [[Part 1.1 - What Actually Matters|Fit series]]).
- It lets you cook real food instead of grabbing whatever is at the office canteen ([[Part 5.0 - The Weekly System|Nutrition Part 5.0]]).
- It lets you protect the [[Part 2.0 - The One Lever|pre-sleep window]] that the [[Part 1.0 - The Architecture of Sleep|Sleep series]] argues is the single highest lever in your health.
- It lets you put a [[Part 3.0 - The First Economy - The Climb|First Economy]] job and a [[Part 3.1 - The Second Economy - The Build|Second Economy]] build in the same day, instead of forcing you to pick.

> [!tip] How to test for real flexibility in an interview
...
| Bucket                        | What it looks like                                                                                       | Leverage shape                                                  |
| ----------------------------- | -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| **Labour leverage**           | People work for you (employees, contractors)                                                             | Linear; needs management; the original kind, hardest to scale   |
| **Capital leverage**          | Money works for you (a business, a portfolio, real estate)                                               | Exponential, but needs the capital first                        |
| **Code & content leverage** | Software and media that work for you (scripts, products, articles, videos, courses, posts that compound) | Asymmetric, near-zero marginal cost, available without capital |
...
- **PR.** As discussed in [[Part 1.0 - What Income Actually Is|Part 1.0]]'s framing of the attribute, PR pays only at the top 1% (head of comms at a Fortune 100). Outside that, it doesn't transfer, doesn't freelance well, and doesn't compound.
...
| Type           | What it is                                                                                                                                                                                                | Competition shape                                          | Pay shape                                                                                       |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| **Mechanical** | Work where you are interchangeable with anyone trained the same way (most factory roles, most call centres, most data-entry, most generic admin, increasingly: anything a model can do without judgement) | Wide and shallow; thousands of you exist                   | Flat, capped, and shrinking as automation gets better                                           |
| **Top 1%**     | Work where everyone is roughly similar, and the differentiator is being *better* (sales, surgery, trading, athletics, some engineering)                                                                   | Narrow and deep; you compete on raw quality                | Steep curve: top 1% earns a lot, top 10% earns fine, top 50% earns badly                        |
| **Unique**     | Work where your specific philosophy, taste, and angle is *the* product (good marketing, branded writing, founder-led businesses, distinctive design, creative direction, original research)               | Crowded but non-substitutable; nobody else is exactly you | Asymmetric: lower floor, but the ceiling is open because the buyer wants *you*, not the output |
...
| Likely growing                                                                                                            | Likely flat                                                          | Likely shrinking                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| AI infrastructure & applied ML, data engineering, cybersecurity, climate/energy transition, healthcare tech, payments/fintech, software in regulated SEA verticals | Most of traditional banking, hospitality, FMCG, classical consulting | Print media, generic call-centre work, lower-tier BPO, retail brokerage, generic admin & data-entry roles |

> [!tip] Bet the way you'd invest, not the way you'd cheer
...
| Attribute               | 0 (avoid)                                                | 1 (acceptable)                                       | 2 (great)                                                                                |
| ----------------------- | -------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| **Flexibility**         | Full office, fixed hours, surveilled remote              | Hybrid, output-measured                              | Remote-default, async-respected, deep work normalised                                    |
| **Leverage**            | Linear hours-for-pay, no portable skill                  | Some transferable skill, modest compounding          | Code/content/capital leverage, output keeps working after you stop                       |
| **Uniqueness / Top 1%** | Mechanical work, easily replaced                         | Top 1% game in a field you can credibly win          | Unique angle backed by Top-1% quality (your taste *plus* your numbers)                   |
| **Living industry**     | Industry headcount and revenue declining for 5+ years    | Flat, stable, defensible                             | Growing tailwind, capital and talent flowing in                                          |
...
> [!note] One attribute that is fixable beats two that aren't
...
Before [[Part 2.0 - Positioning Yourself Cheap and Capable|Part 2.0]] hands you the positioning strategy, score the ground you're standing on.
...
> [!note] Up next
> You know what to optimise for (the four attributes) and how to score it. [[Part 2.0 - Positioning Yourself Cheap and Capable|Part 2.0 — Positioning Yourself Cheap-and-Capable]] is the strategy article: how to actually get into a high-attribute role when you don't yet have the credentials to walk in the front door.
...
[^2]: For industry-slope methodology (using job posting volume, investment flow, and salary drift as composite signals), see the World Economic Forum's *Future of Jobs Report* series, e.g. WEF (2023), *Future of Jobs Report 2023*, Geneva, which builds the growing/shrinking taxonomy used informally above. [weforum.org/publications/the-future-of-jobs-report-2023](https://www.weforum.org/publications/the-future-of-jobs-report-2023/).
