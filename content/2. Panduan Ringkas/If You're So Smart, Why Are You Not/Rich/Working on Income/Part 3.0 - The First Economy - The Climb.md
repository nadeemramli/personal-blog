---
title: "Part 3.0 — The First Economy: The Climb"
draft: false
tags:
  - rich
  - income
...
- [The thesis: climb in three steps, not five](#the-thesis-climb-in-three-steps-not-five)
- [Step 1: the startup (already covered, briefly recapped)](#step-1-the-startup-already-covered-briefly-recapped)
- [Step 2: the scale-up (where the climb actually happens)](#step-2-the-scale-up-where-the-climb-actually-happens)
- [Step 3: the corporate seat, taken overpaid](#step-3-the-corporate-seat-taken-overpaid)
- [The milking phase, and why it's not a slur](#the-milking-phase-and-why-its-not-a-slur)
- [The surplus window: 26 to 28](#the-surplus-window-26-to-28)
- [When the climb stops working](#when-the-climb-stops-working)
...
> [!important] Why three steps and not "climb the corporate ladder"?
...
The [[Part 1.0 - What Income Actually Is|Income 101]] series has, up to this point, been about lens and entry. [[Part 1.0 - What Income Actually Is|Part 1.0]] reframed income as optionality. [[Part 1.1 - The Four Attributes of a Good Job|Part 1.1]] handed over the four-attribute scorecard. [[Part 2.0 - Positioning Yourself Cheap and Capable|Part 2.0]] gave you the strategy to get past the first door.

==This article is the trajectory through *the rest of the first decade*.== It is the path through the First Economy (the one where you trade *capability* for income), and it ends at the point where the [[Part 1.0 - Allocation The Sankey Mindset|Financial System]] series can take over and start moving the surplus into a [[Part 4.0 - The Risk Ladder|wealth machine]].

The other two economies ([[Part 3.1 - The Second Economy - The Build|the Build]] and [[Part 3.2 - The Third Economy - The Catering Game|the Catering Game]]) sit in parallel to this one, and [[Part 4.0 - Stacking Economies and Designing Your Life|Part 4.0]] is about how to layer them. ==But for most people, the climb is the spine, and the other two are vertebrae.==
...
| Step           | Company shape                                                           | What you trade                          | What you stockpile                                                |
| -------------- | ----------------------------------------------------------------------- | --------------------------------------- | ----------------------------------------------------------------- |
| **1. Startup** | Small (<30), no-name, founder-led, in a [[Part 1.1 - The Four Attributes of a Good Job|living industry]] | Low salary for scope + speed of learning | Real outcomes you can point to (revenue moved, products shipped)  |
| **2. Scale-up** | 100–300 people, known but not yet global, still building              | Market-rate salary for visibility + ownership | A track record of impact, a network of peers, a title that means something |
| **3. Corporate** | 1,000+ people, global, structured, hiring senior                       | A premium salary for stability + scope at scale | A surplus that can fund the [[Part 1.0 - Allocation The Sankey Mindset|Financial System]], plus the freedom to walk |
...
[[Part 2.0 - Positioning Yourself Cheap and Capable|Part 2.0]] is the full treatment. The summary, because the climb has to start somewhere:
...
- **Build the side path in parallel.** This is the stage where the [[Part 3.1 - The Second Economy - The Build|Build]] becomes possible: your scale-up salary covers your basics, the flexibility leaves you evenings, and the skill you're sharpening at work is also the skill you can monetise on the side.
...
This is also, structurally, the step where you stop being *cheap* and finally become *expensive*. The cost arithmetic from [[Part 2.0 - Positioning Yourself Cheap and Capable|Part 2.0]] reverses on you. You are no longer the candidate a small company can take a chance on; you are the candidate a big company can absorb. ==Use that.==
...
- You are using the predictable income to build a real surplus, route it into investment, and stabilise the [[Part 1.0 - Allocation The Sankey Mindset|Financial System]] mechanics.
- You are using the flexibility to keep the [[Part 1.0 - What Healthy Actually Is|Healthy]] basics intact (sleep, training, food) and to start or accelerate the [[Part 3.1 - The Second Economy - The Build|Build]] on the side.
...
- **Build the Build.** Use the predictable income to fund the [[Part 3.1 - The Second Economy - The Build|next economy]] (the asset, the brand, the audience, the freelance practice). You'll need it.
...
- The skills are mature enough that the [[Part 3.1 - The Second Economy - The Build|Build]] produces meaningful side income.
- The flexibility is enough to invest in [[Part 1.0 - What Healthy Actually Is|Healthy]], [[Part 1.0 - The Cognitive Architecture|Productive]], and relationships without burning out.
...
The math is not exotic. A surplus of RM 8,000–12,000 a month, invested into a sensible portfolio, compounded over a decade, is the difference between "I have to work for the rest of my life" and "I have real optionality by my mid-30s." This is exactly what the [[Part 4.0 - The Risk Ladder|S-curve]] in the Financial System series is about: the surplus, not the salary, is what bends the curve. ==Income 101 ends here, structurally, because this is where it hands the baton to the Financial System.==

If you missed this window (you're reading this at 32, 35, 40), the strategy doesn't change in *shape*, only in *speed*. ==The climb still works; you just don't get the same compounding runway.== That makes the [[Part 3.1 - The Second Economy - The Build|Build]] more important, not less, and the surplus-discipline more urgent, not less.
...
- **You hate management work and the only path up is into management.** Some climbs end in management; some end in senior IC seats. ==If your scale-up only offers the first and you don't want it, the next move is sideways, not up: to a company that has an IC ladder, or out into the [[Part 3.1 - The Second Economy - The Build|Build]] full-time.==
- **The industry you bet on starts dying.** This is a real risk. Re-read [[Part 1.1 - The Four Attributes of a Good Job|the living-industry attribute]] every year. If the slope inverts on your bet, plan a transition during the milking phase, not after.
...
> - **26 to 28 is the surplus window.** Starting the climb at 20–22 lands you there with real income, low expenses, and enough flexibility to compound aggressively. ==This is where Income 101 hands the baton to the [[Part 1.0 - Allocation The Sankey Mindset|Financial System]].==
> - **The climb stops working** when the industry dies, when the only path up is management you don't want, or when the [[Part 3.1 - The Second Economy - The Build|Build]] outpaces it. Recognise the signal; don't stay past the payoff.
...
4. **Map your industry's slope every 12 months.** Re-read [[Part 1.1 - The Four Attributes of a Good Job|Part 1.1's industry attribute]] and re-score. Adjust if the slope has inverted.
5. **Schedule the surplus window.** If you are anywhere near 26–28 in a corporate seat, this is the moment to formalise the surplus discipline. The [[Part 1.0 - Allocation The Sankey Mindset|Financial System Part 1]] is the next read.

> [!note] Up next
> The climb is the spine of the First Economy. [[Part 3.1 - The Second Economy - The Build|Part 3.1 — The Second Economy: The Build]] is the *vertebrae* that runs in parallel: an asset, a brand, a creative practice that pays you not for what you can do but for what you have. The two economies stack, and most people who reach real optionality run both.
...
[^1]: For the empirical case that wage growth in early career is driven primarily by job-switching rather than within-firm promotions, see Topel, R.H. & Ward, M.P. (1992), "Job Mobility and the Careers of Young Men," *Quarterly Journal of Economics* 107(2):439–479. The finding (that two-thirds of early-career wage growth comes from changing employers, not staying) is the structural reason planned exits beat loyalty in a modern climb. [academic.oup.com/qje/article-abstract/107/2/439/1838025](https://academic.oup.com/qje/article-abstract/107/2/439/1838025).
