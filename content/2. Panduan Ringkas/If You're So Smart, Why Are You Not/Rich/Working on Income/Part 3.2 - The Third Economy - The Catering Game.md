---
title: "Part 3.2 — The Third Economy: The Catering Game"
draft: false
tags:
  - rich
  - income
...
- [The thesis: catering is renting time at a small margin](#the-thesis-catering-is-renting-time-at-a-small-margin)
- [What the catering economy actually contains](#what-the-catering-economy-actually-contains)
- [Why the marketing is so good](#why-the-marketing-is-so-good)
- [The top 1% of the catering game (and the bait)](#the-top-1-of-the-catering-game-and-the-bait)
...
> [!important] Why an article about a layer the series doesn't recommend?
...
The first two economies of this series are *constructive*: the [[Part 3.0 - The First Economy - The Climb|Climb]] constructs your capability, the [[Part 3.1 - The Second Economy - The Build|Build]] constructs your asset. The third economy is *extractive*: it converts your time into someone else's revenue, at a small commission, with no asset left behind.
...
[[Part 4.0 - Stacking Economies and Designing Your Life|Part 4.0]] (the synthesis) is going to argue for stacking economies. The honest version of that argument is that the first two stack productively; the third can sit alongside them for short, specific reasons, but it does not stack into anything bigger.
...
- **The faces selling it are good at selling it.** The top earners in most catering categories are the people who are good at *content about* the catering, which is a much rarer skill than the catering itself. That skill is also a [[Part 3.1 - The Second Economy - The Build|Build]] skill (it is content, brand, audience), which is why those people end up successful. ==Their success often has more to do with the Build they accidentally ran than with the catering they taught.==
...
> [!tip] If you do this, do the asset version
> Run the affiliate program *on top of* a [[Part 3.1 - The Second Economy - The Build|Build]] you would have run anyway: a niche newsletter, a YouTube channel, a review site with a real point of view. ==The affiliate revenue is a tax-efficient kicker; it should not be the reason you started.==
...
- **Catering displaces Build hours.** If you have four blocked evenings for a [[Part 3.1 - The Second Economy - The Build|Build]] and you give two of them to affiliate-spam or a dropship store, the Build dies on cadence. ==You traded a compounding hour for a non-compounding one.==
...
> - **The top 1% of the catering game looks like the [[Part 3.1 - The Second Economy - The Build|Build]].** Most of their income is from teaching the catering, not doing it. The funnel is the asset; the catering is the credential.
...
1. **List every catering activity you currently run.** Be specific (Grab hours per week, affiliate accounts, dropship stores, MLM positions, sales-agent gigs).
2. **For each, write the honest monthly net (after fuel, fees, time, taxes).** Not gross. Net.
3. **For each, ask the litmus test:** if this works for the next 12 months, what asset do I own at the end? Cut anything where the answer is "nothing" and the income is not material.
4. **Re-allocate the freed hours** to either the [[Part 3.0 - The First Economy - The Climb|Climb]] (more rest, better Monday) or the [[Part 3.1 - The Second Economy - The Build|Build]] (four blocked evenings, not three).
...
[^1]: For the structural compression of gig-economy margins over time, see Hall, J.V. & Krueger, A.B. (2018), "An Analysis of the Labor Market for Uber's Driver-Partners in the United States," *ILR Review* 71(3):705–732 — early-platform data showed gig pay above local-equivalent labour, but the time-trend of per-hour earnings has tracked downward as supply has matched and outpaced demand. The Malaysian gig market follows a similar curve. [journals.sagepub.com/doi/10.1177/0019793917717222](https://journals.sagepub.com/doi/10.1177/0019793917717222).

[^2]: On the "course is the business, the catering is the credential" pattern, see Vahn Hagen et al., academic analyses of "creator economy creator economies": the most consistently profitable nodes in catering-style funnels are infomediary products (courses, masterclasses, paid communities), not the underlying activity being taught. This pattern is also documented across MLM literature (e.g. FTC guidance on MLM income disclosures, 2018) — the median participant earns negligible income from product sales; the income is concentrated in the upline and in the training materials.

[^3]: On affiliate's structural durability, see the Performance Marketing Association's annual industry-size estimates, which have shown a steadily growing affiliate spend over multiple decades despite repeated predictions of its decline. Affiliate has survived because intent-captured content converts at multiples of paid ads, which keeps advertisers paying. [performancemarketingassociation.com](https://www.performancemarketingassociation.com/).
