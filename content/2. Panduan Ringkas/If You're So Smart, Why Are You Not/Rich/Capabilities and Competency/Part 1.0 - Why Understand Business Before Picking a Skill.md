---
title: Part 1.0 — Why Understand Business Before Picking a Skill
draft: false
tags:
  - rich
  - capabilities
...
> [!abstract] This is **Part 1 of 13** in the Capabilities and Competency series, the targeting layer of the [[Part 1.0 - What Income Actually Is|Rich]] section. [[Part 1.0 - What Income Actually Is|Income 101]] told you why income matters and how to position yourself. [[Part 1.0 - Allocation The Sankey Mindset|Multiplying Money 101]] tells you what to do with the income once it lands. This series sits in between and answers the harder question: *which* specific skill is actually worth getting good at, for which kind of business, and who pays for it. The full path:
>
> - **Part 1 — How to think before you start:**
>   - **Part 1.0 (this article):** [[Part 1.0 - Why Understand Business Before Picking a Skill|Why Understand Business Before Picking a Skill]] (the targeting move; theory needs experience to mean anything)
> - **Part 2 — How a business actually works:**
>   - **Part 2.0:** [[Part 2.0 - The Profit Engine|The Profit Engine]] (profit equals in minus out; the bottleneck idea)
>   - **Part 2.1:** [[Part 2.1 - The Numbers That Tell You If It Works|The Numbers That Tell You If It Works]] (unit economics in plain words)
>   - **Part 2.2:** [[Part 2.2 - The Map of a Business|The Map of a Business]] (the triad, zoomed in by the Business Model Canvas)
>   - **Part 2.3:** [[Part 2.3 - The Four Jobs Every Business Has|The Four Jobs Every Business Has]] (grow, keep, defend, multiply)
> - **Part 3 — Where value lives, and why the same skill is worth different amounts:**
>   - **Part 3.0:** [[Part 3.0 - Making Value vs Keeping Value|Making Value vs. Keeping Value]] (the industry decides which is the centre of gravity)
>   - **Part 3.1:** [[Part 3.1 - Power|Power: Why Some Businesses Keep Their Profit]] (the seven powers; USP is downstream)
>   - **Part 3.2:** [[Part 3.2 - The Stages of a Business|The Stages of a Business]] (phase × constraint matrix)
> - **Part 4 — The two big levers:**
>   - **Part 4.0:** [[Part 4.0 - Bringing in Sales|Bringing in Sales]] (the funnel; sales always necessary, not always the bottleneck)
>   - **Part 4.1:** [[Part 4.1 - Cutting Cost Without Breaking Things|Cutting Cost Without Breaking Things]] (operations, supply chain, retention)
> - **Part 5 — How work gets organized:**
>   - **Part 5.0:** [[Part 5.0 - Goals and Structure|Goals and Structure]] (find the owner of the number you can move)
> - **Part 6 — Putting it together:**
>   - **Part 6.0:** [[Part 6.0 - From a Business to the Exact Skill|From a Business to the Exact Skill]] (the full chain on a real example)
>   - **Part 6.1:** [[Part 6.1 - Run It on Yourself|Run It on Yourself]] (you are a one-person business; the handoff)
> ----

## Table of Contents

- [Where this series sits](#where-this-series-sits)
- [The thesis: skill is meaningless without a target](#the-thesis-skill-is-meaningless-without-a-target)
- [The "I need to learn X" trap](#the-i-need-to-learn-x-trap)
- [Why theory is just noise before experience](#why-theory-is-just-noise-before-experience)
- [The pain × reflection model](#the-pain--reflection-model)
- [How every article in this series will be built](#how-every-article-in-this-series-will-be-built)
- [What you should walk away from this series with](#what-you-should-walk-away-from-this-series-with)
...
> [!important] Why start with "understand business" and not "pick a skill"
...
- **The 90/10 rule.** From [[Part 1.0 - What Income Actually Is|Income 101]] and the [[Part 4.0 - Pharmacology|Fit series]] and the [[Part 1.0 - What Nutrition Actually Is|Nutrition series]]: 90% of the result is the boring structural work, and 10% is the chemistry. In capability terms, the 90% is picking the right skill for the right stage of business in the right industry. The 10% is the polish (the side project, the certificate, the personal brand). Most people invert it: they over-polish a skill the market doesn't need much of.

> [!note] A note on what this series is *not*
...
> [!tip] If you only remember one sentence from this article
...
> [!warning] A predictable failure mode
...
The way capability actually builds is not "read theory → apply theory." It's [[Reflection & Decision Making|pain × reflection]], compounded.
...
- **A clear handoff:** the learning-and-practice series, which is downstream of this one, picks up "now go build it." The sales mechanism inside Part 4.0 of this series, plus the positioning logic from [[Part 2.0 - Positioning Yourself Cheap and Capable|Income 101 Part 2.0]], picks up "now go sell it."
...
Before [[Part 2.0 - The Profit Engine|Part 2.0]] introduces the profit engine, get the targets set up. This week is observation, not skill-picking.
...
4. **Read or re-read [[Part 4.0 - Stacking Economies and Designing Your Life|Income 101 Part 4.0 (Stacking Economies)]].** This series picks up where that one ended.
...
The "skill is meaningless without a target" framing is a synthesis of a few overlapping arguments. [Cedric Chin's writing on business triads](https://commoncog.com) (the capital / operations / market split that Part 2.2 will use) is one of the clearest treatments of *why* the same skill behaves differently in different businesses. The [theory of constraints](https://en.wikipedia.org/wiki/Theory_of_constraints) (Eliyahu Goldratt's *The Goal*, 1984) is the formal version of the bottleneck idea introduced in Part 2.0. The "pain × reflection" framing draws on the long tradition of deliberate-practice research (K. Anders Ericsson, *Peak*, 2016) and the related working-class wisdom that experience without reflection is just years of repeating the same mistake.
