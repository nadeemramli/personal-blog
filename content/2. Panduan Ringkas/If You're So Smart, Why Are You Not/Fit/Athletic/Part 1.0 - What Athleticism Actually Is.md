---
title: Part 1.0 — What Athleticism Actually Is
draft: false
tags:
  - fitness
  - athleticism
...
date: 2026-05-25
---
> [!abstract] This is **Part 1 of 5** in the Athletic Series — the companion track to the [[Part 1.1 - What Actually Matters|main Fitness Series]]'s *Aesthetic & Strength* path. If that series built the **chassis**, this one builds the **engine**. The full path:
> 
> - **Part 1 (this article):** [[Part 1.0 - What Athleticism Actually Is|What Athleticism Actually Is]] — the framework
> - **Part 2 — The Engine (2 sub-articles):**
> 	- **Part 2.0:** [[Part 2.0 - Energy Systems and the Aerobic Base|Energy Systems & the Aerobic Base]] — the three systems and the floor
...
> - **Part 4 — Integration:** [[Part 4.0 - Concurrent Training|Concurrent Training]] — fitting the engine next to the chassis without killing your gains
> - **Part 5 — Putting It Together:** [[Part 5.0 - The Athletic Standard|The Athletic Standard]] — the testing battery, the worked example, and the longevity dividend
> ----
## Table of Contents

- [Where this series picks up](#where-this-series-picks-up)
- [Fit vs. Healthy — and why Athletic is the bridge](#fit-vs-healthy--and-why-athletic-is-the-bridge)
- [The six athletic qualities](#the-six-athletic-qualities)
- [Qualities are outputs — the engine underneath is three energy systems](#qualities-are-outputs--the-engine-underneath-is-three-energy-systems)
- [VO2 max: the master metric](#vo2-max-the-master-metric)
- [Mitochondria: the master adaptation](#mitochondria-the-master-adaptation)
- [Measuring athleticism: the field-test battery](#measuring-athleticism-the-field-test-battery)
- [How benchmarking is used (the athletic diagnostic tree)](#how-benchmarking-is-used-the-athletic-diagnostic-tree)
- [The catch: the interference effect](#the-catch-the-interference-effect)
- [The tools](#the-tools)
...
> [!important] What this series is, and isn't
> The [[Part 1.1 - What Actually Matters|Aesthetic & Strength series]] is about how you look and how much force you can produce. This series is about everything else the body can do: ==sustain effort, repeat it, change direction, and recover between bouts.== If you only ever lift, you build a powerful chassis bolted to a weak engine — a car that looks fast in the driveway and overheats on the first lap. This is the engine.

## Where this series picks up

Back in [[Part 1.1 - What Actually Matters|Part 1.1]], I made a deliberate cut. I said there were four ways to be *fit* — Aesthetic, Strength, Agility, and Endurance — and then I argued that two of them, **Agility and Endurance, actually belong to a different category entirely: _Athleticism_.** I set them aside, because for the average gym-goer chasing a better physique, they aren't the metrics driving the daily workout.
...
In [[Part 1.1 - What Actually Matters|Part 1.1]] I drew a hard line between two ideas that people constantly conflate:
...
> [!tip] The two-dividend investment
...
| **Quality** | **Definition** | **Above-average / athletic benchmark** |
| --- | --- | --- |
| **1. Strength** | Max force production | Men: 1.5× BW bench, 2× BW deadlift; Women: 1× BW bench, 1.5× BW deadlift |
| **2. Endurance** | Sustained effort (cardiac + muscular) | 1.5-mile run: <10:30 (men), <12:00 (women); 60+ push-ups in 2 min |
| **3. Mobility** | Usable joint ROM + stability | Sit-and-reach >15 cm past toes; single-leg balance >60 s eyes closed |
| **4. Agility** | Rapid direction change + reaction | 5-10-5 shuttle: <4.5 s (men), <5.0 s (women); ruler-drop reaction <15 cm |
| **5. Coordination** | Skillful movement integration | 50+ consecutive tennis wall rallies; clean 10 m precision dribble (soccer) |
...
This is the athletic-training equivalent of "[[Part 1.1 - What Actually Matters#How muscle actually grows|how muscle actually grows]]" from Part 1.1 — the mechanistic floor everything else rests on.

> [!note] The three energy systems
...
This is why this series spends its first real chapter ([[Part 2.0 - Energy Systems and the Aerobic Base|Part 2.0]]) on the aerobic base before it ever touches sprint work. ==The diesel engine is the foundation that makes the sprint engine usable more than once.==
...
It's also, per the [Mandsager data](#fit-vs-healthy--and-why-athletic-is-the-bridge), the metric most tightly bound to how long you live. Master metric on both sides of the Fit/Healthy line.
...
| Band | Men (mL/kg/min) | Women (mL/kg/min) |
| --- | --- | --- |
| Poor | < 38 | < 30 |
| Average | 38–44 | 30–37 |
| Good | 45–51 | 38–44 |
| Excellent | 52–60 | 45–52 |
| Athletic / Elite | 60+ (elite endurance athletes hit 75–85+) | 52+ (elite women hit 65–75+) |

> [!caution] VO2 max declines with age — but the decline is negotiable
...
2. **Wearable estimate — RM you already spent.** A **Garmin, Apple Watch, or Whoop** estimates VO2 max from the relationship between your heart rate and your running pace. The absolute number can be off by several points, but ==the *trend* is reliable== — which, exactly as with the body-fat scale in [[Part 1.1 - What Actually Matters#Understanding body fat measurement: the three scanner tiers|Part 1.1]], is what you actually use it for.
...
> [!tip] The practical play (sound familiar?)
> Use your **wearable for the continuous trend**, and a **field test (or a lab test) every few months for an honest anchor.** It's the same "continuous data + periodic ground-truth" pattern from the [[Part 1.1 - What Actually Matters#Understanding body fat measurement: the three scanner tiers|body-fat scanner tiers]] — because it's the same problem.
...
> [!note] Floor vs. ceiling — two different stimuli
...
The practical upshot, which surprises every lifter: **most of your engine work should be *easy*.** The endless huffing-and-puffing "medium-hard" cardio that most people grind out lives in a no-man's-land — too hard to accumulate the volume that builds mitochondria, too easy to push the ceiling. The polarized approach — lots of genuinely easy, a little genuinely hard, almost nothing in between — is what [[Part 2.0 - Energy Systems and the Aerobic Base|Part 2.0]] and [[Part 2.1 - VO2 Max and Mitochondria|Part 2.1]] are built around.

And notice the through-line back to the chassis series. In [[Part 1.1 - What Actually Matters#How muscle actually grows|Part 1.1]], the lever that drove everything was *myofibrillar hypertrophy backed by satellite cells.* Here, ==the lever that drives everything is *mitochondrial biogenesis backed by a high lactate threshold.*== Same logic, different tissue. Find the adaptation that compounds, then point the whole program at it.

## Measuring athleticism: the field-test battery

The measurement philosophy from [[Part 1.1 - What Actually Matters#Fitness can be measured and measurable benchmarks (and rate of progress) matter|Part 1.1]] transfers directly: every quality here is **quantifiable**, the numbers come in **relative** and **absolute** flavours, and the **rate of progress is itself a signal.** What changes is the test list. Run these to establish your baseline:

| Quality | Field test | Athletic target (men / women) |
| --- | --- | --- |
| **Aerobic endurance** | VO2 max (lab or wearable) | 52+ / 45+ mL/kg/min |
| **Aerobic endurance** | 1.5-mile run | <10:30 / <12:00 |
| **Muscular endurance** | Push-ups in 2 min | 60+ / 40+ |
| **Power (vertical)** | Vertical jump | 24"+ / 18"+ |
| **Power (horizontal)** | Standing broad jump | >8' / >6.5' |
| **Agility** | 5-10-5 pro-agility shuttle | <4.5 s / <5.0 s |
| **Reaction** | Ruler-drop test | <15 cm catch distance |
| **Mobility** | Sit-and-reach | >15 cm past toes |
| **Balance/stability** | Single-leg stand, eyes closed | >60 s |
| **Coordination** | Tennis wall rally (consecutive) | 50+ |

> [!warning] Know what your test actually measures
...
This is the part that turns numbers into decisions — the athletic mirror of Part 1.1's [[Part 1.1 - What Actually Matters#How Benchmarking is Used (The Diagnostic Decision Tree)|diagnostic decision tree]]. When a quality stalls, the *pattern* of which numbers move and which don't tells you the cause.
...
- **Symptom:** Your **max strength is climbing** (squat/deadlift up) but your **jump is flat.**
    ...
    - *Action:* Add explosive, low-rep, full-intent work (jumps, throws, light speed work) — and revisit the [[Part 1.1 - What Actually Matters#So what actually matters for Aesthetic and Strength?|strength base]], because power has a strength prerequisite you can't skip.
...
There's a reason you can't just bolt this series onto the [[Part 1.1 - What Actually Matters|Aesthetic & Strength]] program and expect both to thrive. They fight at the molecular level.
...
This is the single most important integration problem in training both engine and chassis, and it gets its own chapter: [[Part 4.0 - Concurrent Training|Part 4.0 — Concurrent Training]]. For now, just hold the warning: **more cardio is not free.** It's bought with some of your gains, and the goal is to pay the smallest possible price.

## The tools

Same philosophy as the [[Part 1.1 - What Actually Matters|chassis series]]' Hevy / MacroFactor / InBody stack — keep data-collection friction near zero by splitting it across dedicated tools:
...
> [!note] The 90/10 rule still holds
...
4. **Learn your Zone 2:** Find the heart-rate ceiling for your easy pace (roughly the highest HR at which you can still hold a full conversation). You'll live here a lot in [[Part 2.0 - Energy Systems and the Aerobic Base|Part 2.0]].
5. **Confirm your chassis baseline exists:** If you haven't already logged the [[Part 1.1 - What Actually Matters#So what actually matters for Aesthetic and Strength?|strength benchmarks]] from Part 1.1, do that too — power and agility are built on a strength base, and you'll need the number.

> [!note] Up next is [[Part 2.0 - Energy Systems and the Aerobic Base|Part 2.0 — Energy Systems & the Aerobic Base]], where we build the diesel engine: the three systems in depth, the lactate threshold, and why most of your cardio should be boring and easy.
> 
> Then [[Part 2.1 - VO2 Max and Mitochondria|Part 2.1]] goes deep on the master metric and the master adaptation.
> 
> To train the individual outputs, skip to [[Part 3.0 - Endurance and Work Capacity|Part 3 — The Five Qualities]]. To learn how to run this alongside lifting without killing your gains, jump to [[Part 4.0 - Concurrent Training|Part 4 — Concurrent Training]].
...
[^1]: Mandsager K, Harb S, Cremer P, et al. (2018). "Association of Cardiorespiratory Fitness With Long-term Mortality Among Adults Undergoing Exercise Treadmill Testing." *JAMA Network Open*, 1(6):e183605. Cohort of 122,007 patients; cardiorespiratory fitness inversely associated with all-cause mortality with no observed upper limit of benefit. [Full text — JAMA Network Open](https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2707428) and [PMC6324439](https://pmc.ncbi.nlm.nih.gov/articles/PMC6324439/).

[^2]: Functional/athletic benchmarks drawn from sport and combine-style testing standards (NFL combine, military fitness tests) at the "elite / above-average" recreational level. Female benchmarks run ~60–80% of male values, with smaller gaps in lower-body and endurance qualities — consistent with the strength-standards adjustment in [[Part 1.1 - What Actually Matters|Part 1.1]]. See standing broad jump norms at [fitnessnorms.com](https://fitnessnorms.com/strength/standing-broad-jump/) and vertical-jump norms at [topendsports.com](https://www.topendsports.com/testing/norms/vertical-jump.htm).

[^3]: Three energy systems overview: phosphagen (ATP-PC) fully tapped in ~8–10 s and needs 3–5 min to recover; glycolytic covers ~10 s–2 min before lactate accumulation; oxidative powers everything beyond ~2 min and drives recovery between bouts. See [Breaking Muscle — Understanding Energy Systems](https://breakingmuscle.com/understanding-energy-systems-atp-pc-glycolytic-and-oxidative-oh-my/) and [US Army — Understanding the Three Energy Systems](https://www.army.mil/article/254967/understanding_the_three_energy_systems_used_during_exercise).

[^4]: VO2 max norms by age and sex based on the Cooper Institute and ACSM fitness classifications. Men aged 20–29 median ≈48 mL/kg/min; women ≈37.6, both declining ~8–10% per decade; recreationally fit males 50–60, elite 75–85+; recreationally fit females 45–55, elite 65–75+. See [FitnessNorms — VO2 Max](https://fitnessnorms.com/cardio/vo2-max/) and [BodySpec — VO2 Max Chart](https://www.bodyspec.com/blog/post/vo_max_chart_benchmarks_and_insights_for_cardiovascular_health).

[^5]: Estimating VO2 max from field tests: the 12-minute Cooper test and 1.5-mile run feed validated formulas (Kenneth Cooper, 1968). See [Cooper test — whyiexercise.com](https://www.whyiexercise.com/cooper-test.html) and the walk/run validity meta-analysis at [PMC4795745](https://pmc.ncbi.nlm.nih.gov/articles/PMC4795745/).

[^6]: Zone 2 training drives mitochondrial biogenesis via the PGC-1α pathway, raising mitochondrial density and lactate threshold (the "floor"); high-intensity intervals are the direct stimulus for raising the absolute VO2 max "ceiling." See [Data Driven Athlete — Zone 2 guide](https://www.datadrivenathlete.org/blog/zone-2-training-complete-guide) and [Biology Insights — Does Zone 2 improve VO2 max?](https://biologyinsights.com/does-zone-2-training-improve-vo2-max/).

[^7]: The 5-10-5 pro-agility test measures *change-of-direction speed* in a pre-planned pattern rather than true reactive agility, since the athlete isn't responding to an unpredictable stimulus; times ≤4.5 s indicate a good athlete. See [Science for Sport — Pro-Agility Test](https://www.scienceforsport.com/pro-agility-5-10-5-test/) and [Physiopedia](https://www.physio-pedia.com/Pro-Agility_(5-10-5)_Test).

[^8]: The interference effect: resistance training drives hypertrophy via mTOR, endurance training drives adaptation via AMPK, and AMPK suppresses mTOR — so concurrent training can blunt strength/hypertrophy gains, with the effect scaling with endurance intensity. See [Barbell Medicine — Concurrent Training and the Interference Effect](https://www.barbellmedicine.com/blog/concurrent-training-and-the-interference-effect/) and Baar K., "Using Molecular Biology to Maximize Concurrent Training," *Sports Medicine* (2014), [PMC4213370](https://pmc.ncbi.nlm.nih.gov/articles/PMC4213370/).
