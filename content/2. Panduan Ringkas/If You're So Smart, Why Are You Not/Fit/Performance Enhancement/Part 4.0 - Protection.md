...
date: 2026-05-25
---
> [!abstract] This is **Part 4 of 5** in the Performance Enhancement Series — the "Tier 3" continuation of the [[Part 4.0 - Pharmacology|Fitness Series' Pharmacology chapter]]. The full path:
> 
...
> 	- **Part 4.0 (this article):** [[Part 4.0 - Protection|Protection]] — staying alive and intact
...
- [What "protection" actually means](#what-protection-actually-means)
- [Cardiovascular: the thing most likely to kill you](#cardiovascular-the-thing-most-likely-to-kill-you)
    - [How the damage actually happens](#how-the-damage-actually-happens)
    - [Lipids](#lipids)
    - [Blood pressure](#blood-pressure)
    - [Hematocrit and blood viscosity](#hematocrit-and-blood-viscosity)
    - [The heart muscle itself](#the-heart-muscle-itself)
- [Liver](#liver)
- [Kidneys](#kidneys)
- [Estrogen and prolactin management](#estrogen-and-prolactin-management)
- [Fertility and the HPTA: HCG, PCT, and the TRT question](#fertility-and-the-hpta-hcg-pct-and-the-trt-question)
- [Hair: the other finite resource](#hair-the-other-finite-resource)
- [The rest: sleep, mind, skin, glucose](#the-rest-sleep-mind-skin-glucose)
- [Super Ancillaries: drugs that pull double duty](#super-ancillaries-drugs-that-pull-double-duty)
- [The protection stack and monitoring schedule](#the-protection-stack-and-monitoring-schedule)
- [The longevity philosophy](#the-longevity-philosophy)
- [The series in one page](#the-series-in-one-page)
- [Part 4 Takeaways](#part-4-takeaways)
- [Your Protection Task List](#your-protection-task-list)
...
Androgens shift your lipid profile the wrong way: **HDL drops, LDL and ApoB climb.** Oral 17-alpha-alkylated compounds (Dianabol, Anadrol, Winstrol, Halotestin) do this hardest and fastest — they can flatten HDL within weeks. Crashed estradiol makes it worse, which is one more reason not to abuse AIs (see [[Part 3.0 - The Eight Anabolic Pathways|Pathway 3]]).

Defense:

- **Minimize orals** — duration and dose. They are the worst offenders for the smallest muscle-retention benefit.
- **Don't crash estradiol** — estrogen is lipid-protective; manage it with [[Part 3.0 - The Eight Anabolic Pathways|injection frequency, not AIs]].
...
- **Keep saturated fat moderate** during harsh cycles, and **keep doing cardio** — the [[Part 1.1 - What Actually Matters|"boring" base]] does real work here.
- **Watch HDL and ApoB** on your [[Part 2.0 - Medical Screening and Monitoring|mid-cycle bloods]]; if HDL is heading toward single digits, that's a signal to change the protocol, not to push through.
...
- **Measure at home, constantly** (the [[Part 2.0 - Medical Screening and Monitoring|Part 2]] cuff). Target generally **<130/80**; a trend upward is your earliest, cheapest warning.
...
- **Limit oral duration** (the [[Part 3.0 - The Eight Anabolic Pathways|≤8-week / contest-prep-only]] discipline from Part 3 applies).
...
- **Prolactin:** This is the one that misbehaves on **19-nors** ([[Part 3.0 - The Eight Anabolic Pathways|Pathway 4]]). Mild support includes **P5P (vitamin B6)** and **vitamin E**; for significant elevation, **cabergoline** is effective but is a potent dopamine agonist with real side effects (and rare valvular concerns at high chronic doses) — **physician-only,** and a strong argument for just not running heavy 19-nors in the first place.

---
## Fertility and the HPTA: HCG, PCT, and the TRT question

[[Part 1.0 - The Decision|Part 1]] said this is probably a lifetime commitment, and [[Part 2.0 - Medical Screening and Monitoring|Part 2]] had you bank a fertility baseline. Here's how the suppression is actually managed.

**On cycle — protecting the testes:**

- **HCG** mimics LH and keeps the testes active during suppression, preserving testicular size and **intratesticular testosterone** (which matters for fertility and makes recovery easier). It also feeds the [[Part 3.0 - The Eight Anabolic Pathways|progesterone pathway]] usefully.
...
> [!caution] Compound selection is your first hair defense
> If hair matters to you, the biggest lever isn't a drug you add — it's the compounds you *don't* run. DHT-derivatives and high androgenic load are hardest on follicles. This is, again, the [[Part 3.0 - The Eight Anabolic Pathways|moderate approach]] paying off.
...
- **Mental health and aggression.** Supraphysiological androgens can affect mood, irritability, and aggression; some compounds (trenbolone especially) are notorious for it. Watch it honestly, and treat a bad reaction as a reason to change the protocol. [[Part 1.0 - The Decision|Part 1]] also flagged the psychological trap of being unable to stop — take that seriously.
- **Acne and skin.** Androgen-driven; managed with the usual dermatological tools, and improved by keeping DHT and estrogen sane.
- **Glucose.** GH and insulin ([[Part 3.0 - The Eight Anabolic Pathways|Pathways 7 & 8]]) impair insulin sensitivity — keep **fasting glucose and HbA1c** on the monitoring list whenever they're in play.

---
## Super Ancillaries: drugs that pull double duty

The foundational moves come first, always: lower dose, fewer orals, manage estrogen instead of crushing it, cardio, sleep, and relentless [[Part 2.1 - Continuous Monitoring|monitoring]]. But when a marker won't come back into range on lifestyle and supplements alone — or when an athlete is going to run regardless — there's a tier of pharmacological defense. ==The best of these are **"super ancillaries": single drugs that pull double or triple duty,** defending more than one front at once.== Grouped by mechanism:

**Lipid defense — close the cholesterol doors.** This is the direct counter to the [[#how-the-damage-actually-happens|hepatic-lipase dyslipidemia]] above.
...
- **Telmisartan** (your [[#blood-pressure|BP]] ARB) is itself double-duty — a partial PPAR-γ agonist that also nudges insulin sensitivity and lipids. **Nebivolol** is a beta-blocker that a