...
date: 2026-05-25
---
> [!abstract] This is **Part 5.2 of 5** in the Performance Enhancement Series — the "Tier 3" continuation of the [[Part 4.0 - Pharmacology|Fitness Series' Pharmacology chapter]]. The full path:
> 
...
> 	- **Part 5.2 (this article):** [[Part 5.2 - Cost|Cost]] — budgeting & stock planning
> ----
## Table of Contents
...
- [Part 5.2 Takeaways](#part-52-takeaways)
...
You cannot budget what you haven't planned. Start from your [[Part 3.2 - Cycle Design|cycle design]] and [[Part 5.1 - Putting It All Together|year map]], then write down **every variable that will draw money** over that window — not just the obvious gear:

- **The compounds** — each one's dose × weeks = total needed (Step 2 turns this into boxes/vials). From [[Part 5.1 - Putting It All Together|the worked example]]: a Test base, maybe EQ, the occasional oral, HCG/HMG for the down-period.
...
- **Bloodwork** ([[Part 2.0 - Medical Screening and Monitoring|2.0]] / the [[Part 5.1 - Putting It All Together|cadence]]) — a real, recurring line item: the comprehensive baseline panel, then quarterly panels, with extra draws around compound changes.
...
1. **Write the year plan first** ([[Part 5.1 - Putting It All Together|Part 5.0]] calendar) — phases, compounds, ancillary tiers, bloodwork cadence.
...
[^1]: The cost-management framework — planning the cycle before budgeting, predicting stock from dose × duration, the "true monthly burn rate" from bulk purchasing, and tablet-splitting to stretch supply — follows the harm-reduction / evidence-based PED-management approach (Vigorous Steve and similar), applied to the [[Part 3.2 - Cycle Design|cycle-design]] and [[Part 5.1 - Putting It All Together|year-map]] from this series. Figures are illustrative.
