---
title: Part 4.4 — Electrolyte Management
draft: false
tags:
  - fitness
  - pharmacology
...
date: 2026-05-25
---
> [!abstract] This is **Part 4.4 of 5** in the Performance Enhancement Series — the "Tier 3" continuation of the [[Part 4.0 - Pharmacology|Fitness Series' Pharmacology chapter]]. The full path:
> 
...
- [Water retention is the recurring villain](#water-retention-is-the-recurring-villain)
- [Water & hydration: the carrier](#water--hydration-the-carrier)
- [Sodium & the aldosterone counterintuition](#sodium--the-aldosterone-counterintuition)
- [Potassium: the glycogen partner](#potassium-the-glycogen-partner)
- [Magnesium: the relaxation mineral](#magnesium-the-relaxation-mineral)
- [Calcium: the contraction mineral](#calcium-the-contraction-mineral)
- [The ratios and a worked example](#the-ratios-and-a-worked-example)
- [What changes your electrolyte needs](#what-changes-your-electrolyte-needs)
- [Part 4.4 Takeaways](#part-44-takeaways)
- [Your Electrolyte Task List](#your-electrolyte-task-list)
- [Sources & references](#sources--references)

---

> [!danger] Framing
> This article is nutrition and harm-reduction education, not medical advice. Electrolyte targets interact with kidney function, blood pressure, and several of the [[Part 4.2 - Choosing Your Ancillaries|prescription ancillaries]] in this series — over-supplementing potassium alongside an ARB, for instance, can be dangerous. Build your ratios against your own [[Part 2.0 - Medical Screening and Monitoring|bloodwork]] and a physician, especially if you have any kidney or cardiac history.

---
## Water retention is the recurring villain

Trace the problems back through this whole series and one culprit keeps reappearing: **water.** The bloated, smooth look that hides your conditioning? Water. The [[Part 4.0 - Protection|blood pressure]] that climbs on cycle? Largely blood *volume* — water. The flat, weak, "stringy" muscle on a hard cut? Too *little* intracellular water. ==Managing water — not chasing it or starving it — is one of the highest-leverage, least-glamorous things an enhanced athlete does,== and the lever you manage it with is **electrolytes.**

This sub-article sits *after* the [[Part 4.3 - The Bodybuilding Realm|bodybuilding realm]] on purpose, because electrolyte needs are the **convergence point** of almost everything you've read: your [[Part 3.1 - The Anabolic Steroid Family Tree|compound choices]] (aromatizing vs. dry), your [[Part 4.2 - Choosing Your Ancillaries|ancillaries]] (ARBs, diuretics, GH), your [[Part 4.3 - The Bodybuilding Realm|fat-burners]] (clenbuterol burns through potassium), your phase (bulk vs. cut, carb vs. keto), your bodyweight, and your climate all change how much of each mineral you need. You can't set this until you understand the rest — which is why it's here.
...
> [!important] Consistency keeps your kidneys filtering
...
Sodium regulates the body's fluids and is essential for nerve and muscle function. The instinct on cycle or before a photo is to *cut* salt to look dry. ==That backfires, and here's the mechanism.== The hormone **aldosterone** ([[Part 4.0 - Protection|the RAAS again]]) tells the kidneys to *retain* sodium and water (and dump potassium). When you eat *too little* sodium, the body senses low blood volume and **raises aldosterone** — so it clings to every gram of sodium and water it can. Cut salt → high aldosterone → puffy.[^3]

The professional move is the opposite: ==consume sodium in a slight, *consistent* surplus, which keeps aldosterone **low**, so your kidneys are continuously flushing sodium and water out.== Then a cheat or refeed doesn't blow you up, because your body isn't in retention mode — it just excretes the extra. Consistent sodium also means higher blood volume = better nutrient delivery for recovery and growth. (This is also why the [[Part 4.2 - Choosing Your Ancillaries|BP ancillaries]] — tadalafil, telmisartan, nebivolol — pair so well: they let you keep that healthy blood volume while controlling the pressure it creates.)
...
> [!warning] Potassium + an ARB = a real interaction
> ==Do not casually mega-dose potassium if you're on an [[Part 4.2 - Choosing Your Ancillaries|ARB]] (irbesartan/telmisartan) or an MRA== — both raise serum potassium, and stacking high potassium on top risks dangerous hyperkalemia. Get potassium mostly from food, and let [[Part 2.0 - Medical Screening and Monitoring|bloodwork]] confirm your level. This is exactly the kind of ancillary↔electrolyte overlap that makes this the *last* protection topic, not the first.
...
Targets only become useful as a *ratio*, scaled to your bodyweight and training. The reference intakes (adult men 19–50) give the floor — Sodium DRI 1,500 mg, Potassium 4,700 mg, Magnesium ~420 mg, Calcium 1,000 mg[^2] — but a hard-training enhanced athlete sits well above several of those. The working per-bodyweight formulas:[^1]
...
- **Aromatizing compounds + GH** ([[Part 3.0 - The Eight Anabolic Pathways|3.0]]): more estrogen and more GH → more sodium/water retention → you lean harder on consistent sodium + the [[Part 4.2 - Choosing Your Ancillaries|BP ancillaries]], and watch potassium if an ARB is in.
- **Dry vs. wet compounds** ([[Part 3.1 - The Anabolic Steroid Family Tree|3.1]] / [[Part 3.2 - Cycle Design|3.2]]): a Masteron/Primo-heavy "dry" cycle holds less water than a Test/Deca "wet" one — same athlete, different electrolyte feel.
- **Diuretics** ([[Part 4.2 - Choosing Your Ancillaries|4.2]]): indapamide dumps sodium *and* potassium — which is exactly why the diuretic-restraint rule exists, and why crashing electrolytes to "look dry" is dangerous, not clever.
- **Fat-burners** ([[Part 4.3 - The Bodybuilding Realm|4.3]]): clenbuterol depletes potassium and taurine — electrolyte support is part of running it at all.
...
==So electrolytes aren't a fixed daily pill — they track your whole protocol.== When the [[Part 4.1 - When the Numbers Move|numbers move]] (BP up, sudden water weight, cramps), electrolyte balance is one of the first cheap things to check before reaching for a drug.
...
1. **Calculate your baseline** from the formulas — water, sodium, potassium, magnesium, calcium for your bodyweight, training minutes, and carb intake.
2. **Make sodium consistent and deliberate** — a pink-salt + iodised-salt blend, ~500 mg per litre of water, every day (not just training days).
3. **Match potassium to your carbs** — more on a high-carb offseason; supplement (food first) if white rice is your staple. Confirm against bloods if you're on an ARB.
4. **Dial magnesium to tolerance** (glycinate/citrate; loose stool = back off) and keep calcium modest and timed.
5. **Re-tune when your protocol changes** — new compound, fat-burner, diuretic, cut, or season = recalculate, don't coast.
...
[^1]: Vigorous Steve, "Managing Electrolytes for Optimal Bodily Functions" — the source of the water/hydration framework (≈1 L per 10 kg, consistency and the vasopressin point), the sodium–aldosterone "consistent surplus keeps aldosterone low" logic, the potassium-glycogen relationship (~10 mg K per 1 g carbohydrate) and food-source differences (sweet potato vs. white rice), magnesium's self-limiting absorption and role in eccentric muscle relaxation, calcium's role in concentric contraction, the salt-blend (Himalayan + iodised) iodine guidance, and the per-bodyweight formulas and carb/keto ratios. [vigoroussteve.com](https://vigoroussteve.com/managing-electrolytes-for-optimal-bodily-functions/).

[^2]: Dietary Reference Intakes (DRIs) and Upper Limits for adult men 19–50 (Sodium, Potassium, Magnesium, Calcium, Water): U.S. National Institutes of Health, Office of Dietary Supplements / Food and Nutrition Board, Institute of Medicine. [ods.od.nih.gov — Dietary Reference Intakes](https://ods.od.nih.gov/HealthInformation/Dietary_Reference_Intakes.aspx).

[^3]: On the RAAS/aldosterone control of sodium and water and its relevance to androgen-driven fluid retention and blood pressure, see [[Part 4.0 - Protection|Part 4.0]] and its cardiovascular sources; on the ARB/MRA potassium-retention interaction, see [[Part 4.2 - Choosing Your Ancillaries|Part 4.2]].
