---
title: Part 1.0 — The Engine Room (The Goal and the Framework)
draft: false
tags:
  - fitness
...
date: 2026-06-07
---
> [!abstract] This is **Part 1 of 7** in the Aesthetic & Strength **Advanced** series, the science layer under the [[Part 1.1 - What Actually Matters|basic Aesthetic & Strength series]]. The full path:
>
> - **Part 1 (this article):** [[Part 1.0 - The Engine Room|The Engine Room]] - the goal and the framework
> - **Part 2:** [[Part 2.0 - Nutrient Partitioning|Nutrient Partitioning]] - the master variable
> - **Part 3:** [[Part 3.0 - Leptin and Insulin|Leptin and Insulin]] - the sensors
> - **Part 4:** [[Part 4.0 - The Thyroid|The Thyroid]] - the throttle
> - **Part 5:** [[Part 5.0 - The Androgen Receptor|The Androgen Receptor]] - the amplifier
> - **Part 6:** [[Part 6.0 - AMPK and mTOR|AMPK and mTOR]] - the switch
> - **Part 7:** [[Part 7.0 - The Interaction of Mechanisms|The Interaction of Mechanisms]] - how the circuit runs
> ----
## Table of Contents

- [Why an "Advanced" series exists](#why-an-advanced-series-exists)
- [The Goal: three things, in order](#the-goal-three-things-in-order)
- [The Framework: your body is a stack of control loops](#the-framework-your-body-is-a-stack-of-control-loops)
- [The master variable: nutrient partitioning](#the-master-variable-nutrient-partitioning)
- [The five systems that set it](#the-five-systems-that-set-it)
- [The boundary with Performance Enhancement](#the-boundary-with-performance-enhancement)
...
> Partitioning first, budget second, signal third. This is deliberate. The reason is the [[Part 4.0 - Pharmacology|90/10 rule]] in a new costume: if your partitioning is broken (you're bulking at 22% body fat, or cutting so hard you're shedding muscle), no amount of receptor optimisation will save you. Fix the big lever before the small one.
...
In a surplus, a good P-ratio means most of the extra energy becomes muscle. In a deficit, a good P-ratio means most of the loss comes from fat while muscle is spared. The basic series manages this number indirectly, through calories and training and the recomp diagnostic in [[Part 1.1 - What Actually Matters|Part 1.1]]. This series makes it the explicit target.
...
>
> - **The basics are still the basics.** This series explains them; it doesn't replace them. The [[Part 4.0 - Pharmacology|90/10 rule]] still holds.
...
> - **Natural here, enhanced in [[Part 3.0 - The Eight Anabolic Pathways|PE]].** Density and sensitivity on this side of the line; occupancy on the other.

> [!note] Up next
> [[Part 2.0 - Nutrient Partitioning|Part 2.0 — Nutrient Partitioning]] takes the master variable apart: the P-ratio, the Forbes/Hall leanness curve, GLUT4 and the two independent calls, and why the recomp diagnostic you already use is secretly a partitioning readout.

---

> [!warning] Disclaimer Not medical advice. This series describes human physiology and the evidence around it for educational purposes. It reflects a careful reading of the research, not clinical guidance. Consult a qualified medical professional before making significant changes to diet, training, or supplementation, especially with any underlying health condition.

---
## Sources & references

[^1]: The body-fat / P-ratio relationship traces to Forbes (2000), replicated by Hall (2007): leaner individuals partition an energy surplus more favourably toward lean tissue than fatter individuals do. Accessible treatments at Stronger By Science, [The Science of P-Ratios](https://www.strongerbyscience.com/p-ratios-rebuttal/), and Lyle McDonald, [A Guide to Calorie Partitioning](https://bodyrecomposition.com/muscle-gain/a-guide-to-calorie-partitioning). On the optimal body-fat range for muscle growth, see Menno Henselmans, [What's the optimal body fat range for muscle growth?](https://mennohenselmans.com/optimal-body-fat-muscle-growth/). The original modelling: Hall KD, "Body fat and fat-free mass inter-relationships: Forbes's theory revisited," *Br J Nutr* (2007).
...
[^3]: On leptin as the dominant driver of metabolic adaptation: Rosenbaum & Leibel, work on leptin and energy expenditure ([PubMed 26169472](https://pubmed.ncbi.nlm.nih.gov/26169472/)); and "The Fall in Leptin Concentration Is a Major Determinant of the Metabolic Adaptation Induced by Caloric Restriction" ([PMC3167663](https://pmc.ncbi.nlm.nih.gov/articles/PMC3167663/)). Applied context: Trexler, Smith-Ryan & Norton, "Metabolic adaptation to weight loss: implications for the athlete," *J Int Soc Sports Nutr* (2014) ([link](https://link.springer.com/article/10.1186/1550-2783-11-7)).

[^4]: Caloric restriction shifts T4→T3 deiodination toward inactive reverse T3 and can lower circulating T3 substantially, reducing basal metabolic rate. See the adaptive-thermogenesis and skeletal-muscle thyroid-metabolism literature, e.g. [PMC6403129](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6403129/). Deiodinase enzymes are selenoproteins, which is why selenium status matters for conversion. Full mechanism in [[Part 4.0 - The Thyroid|Part 4.0]].

[^5]: Morton et al. (2018), "Muscle Androgen Receptor Content but Not Systemic Hormones Is Associated With Resistance Training-Induced Skeletal Muscle Hypertrophy in Healthy, Young Men" ([PMC6189473](https://pmc.ncbi.nlm.nih.gov/articles/PMC6189473/)). The AR drives hypertrophy partly via the IGF-1/IGF-1R → PI3K/Akt → mTOR pathway ([PMC7106900](https://pmc.ncbi.nlm.nih.gov/articles/PMC7106900/)), which is the physical link to Part 6.0.

[^6]: mTORC1 integrates mechanical tension, amino acids (the leucine threshold), and energy status to drive muscle protein synthesis; AMPK, activated by a high AMP:ATP ratio (energy deficit, endurance work), inhibits mTORC1 via TSC2 and raptor. This reciprocal switch underlies the concurrent-training interference effect. See the Gatorade Sports Science Institute review, [Using Nutrition and Molecular Biology to Maximize Concurrent Training](https://www.gssiweb.org/sports-science-exchange/article/sse-136-using-nutrition-and-molecular-biology-to-maximize-concurrent-training), and the order-of-training studies (Ogasawara et al.). Expanded in [[Part 6.0 - AMPK and mTOR|Part 6.0]] and cross-referenced from [[Part 4.0 - Concurrent Training|Athletic Part 4.0]].
