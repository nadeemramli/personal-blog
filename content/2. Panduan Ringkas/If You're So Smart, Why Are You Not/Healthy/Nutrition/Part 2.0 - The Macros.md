...
date: 2026-05-28
---
> [!abstract] This is **Part 2 of 5** in the [[Part 1.0 - What Nutrition Actually Is|Nutrition Series]]. Where Part 1 named the four levers, this article puts numbers on them. The full path:
> 
> - **Part 1:** [[Part 1.0 - What Nutrition Actually Is|What "Nutrition" Actually Is]]
> - **Part 2 (this article):** [[Part 2.0 - The Macros|The Macros]] — protein first, fat floor, carbs as the lever
...
- [The lever order, restated](#the-lever-order-restated)
- [Protein: the floor, not the ceiling](#protein-the-floor-not-the-ceiling)
- [Fat: still matters, and not just for hormones](#fat-still-matters-and-not-just-for-hormones)
- [Carbs: the flex lever](#carbs-the-flex-lever)
- [A worked example: 80 kg, lean recomp](#a-worked-example-80-kg-lean-recomp)
- [Why you don't need keto, IF, or carnivore](#why-you-dont-need-keto-if-or-carnivore)
- [Protein sources in the Malaysian context](#protein-sources-in-the-malaysian-context)
...
> [!important] Why protein is first, every time
...
[[Part 1.0 - What Nutrition Actually Is|Part 1]] established four levers in priority order. This article fills in the numbers behind each:

1. **Protein** — floor, never moves.
2. **Calories (total)** — direction. Surplus, maintenance, or deficit, set by your goal.
3. **Fat** — floor (don't go below it), with a soft ceiling (it's the densest macro).
4. **Carbs** — the flex lever, pulled up on bulks and down on cuts.
...
- **Going much above 2.5 g/kg adds nothing for natural lifters.** Studies that pushed protein to 3–4 g/kg in trained individuals didn't find more muscle, just more digestion.[^1] The exception is the [[Part 5.0 - Putting It All Together|enhanced lifter on a heavy bulk]], where protein needs scale somewhat with the anabolic environment — but even there, marginal returns drop fast above ~2.5 g/kg.

> [!tip] One number, in your head, forever
...
- **Brain and cell membranes.** Especially omega-3s ([[Part 3.0 - Omega-3, Fiber, and the Gut|next article]]) — but generally, you have a body made partly of fat, and feeding it some is sensible.
...
> [!warning] The fat-quality question
> "How much fat" is one number; "what *kind* of fat" is another, and the second matters for the [[Part 1.0 - What Healthy Actually Is|Healthy]] half. The basics: get most fat from olive oil, nuts, fatty fish, eggs, dairy, and a sensible amount of saturated fat (red meat, butter). Minimise industrial seed oils (the question is contested in detail, settled in the rough direction). The full Healthy/Fit lipid discussion lives in [[Part 4.0 - Protection|PE Part 4.0]] for the enhanced reader and [[Part 1.0 - What Healthy Actually Is|Blueprint]] for everyone else; this article just says: hit the floor with mostly good fats, don't blow the ceiling.
...
- **Evening:** 30 g protein in milk + the [[Part 3.0 - Omega-3, Fiber, and the Gut|prebiotic bowl]] elements as a snack.
...
> [!tip] You will not hit the macros to the gram
...
[[Part 1.0 - What Nutrition Actually Is|Part 1]] said the protocols are the bottom 5% of the stack. Now, with macros set, the case is concrete.
...
| **Carnivore** | Forces protein and fat extremely high, fiber to zero. | Strips one of the better-evidenced Healthy interventions (fiber, [[Part 3.0 - Omega-3, Fiber, and the Gut|next article]]). Often pushes ApoB and LDL up. |
...
> [!note] When *might* you choose a protocol?
...
|---|---|---|---|
| Eggs | 4 large eggs | RM 2.50–3.50 | Cheapest "complete" protein; covers choline ([[Part 3.0 - Omega-3, Fiber, and the Gut|Part 3]]) |
| Chicken breast | ~130 g raw | RM 3–4 | The backbone of most lifters' meal prep |
| Whey isolate (OnTheGo) | ~40 g powder | RM 3.50 | See [[Part 5.0 - The Weekly System|Part 5]] for the full cost model |
...
1. **Calculate your protein number** (bodyweight in kg × 1.6 to 2.2). Write it on the fridge. That's now the floor.
2. **Calculate your fat floor** (bodyweight × 0.8). Write that next to it.
3. **Pick a maintenance calorie estimate** from MacroFactor or a calculator, plus or minus your goal direction (~300 kcal deficit for a cut, ~250 kcal surplus for a bulk, 0 for recomp).
4. **Compute the carb number** from the formula above. You now have a working macro target.
5. **Run it for one week.** Don't aim for perfect. Aim for hitting protein and fat floors and staying within ~±200 kcal of total. Note where you fell short — that's what [[Part 5.0 - The Weekly System|Part 5]] is going to solve with meal prep.

> [!note] Up next
> Macros set the structure. But two things macros don't see show up in your gut, your brain, and your blood: omega-3 fats and fiber. [[Part 3.0 - Omega-3, Fiber, and the Gut|Part 3.0 — Omega-3, Fiber, and the Gut]] is the inputs-beyond-calories article, including the prebiotic bowl recipe.
...
[^1]: Morton, R.W. et al. (2018), "A systematic review, meta-analysis and meta-regression of the effect of protein supplementation on resistance training-induced gains in muscle mass and strength in healthy adults," *British Journal of Sports Medicine* 52(6):376–384 — total protein intake above ~1.6 g/kg/day shows no additional benefit on muscle gain in trained adults; the 1.6–2.2 g/kg range covers nearly all individual variation. [bjsm.bmj.com/content/52/6/376](https://bjsm.bmj.com/content/52/6/376). See also Helms, E.R. et al. (2014), "A systematic review of dietary protein during caloric restriction in resistance trained lean athletes: a case for higher intakes," *International Journal of Sport Nutrition and Exercise Metabolism* 24(2):127–138, which makes the case for the upper end of that range *specifically during a cut*.

[^2]: Schoenfeld, B.J. & Aragon, A.A. (2018), "How much protein can the body use in a single meal for muscle-building? Implications for daily protein distribution," *Journal of the International Society of Sports Nutrition* 15:10 — roughly 0.4 g/kg per feeding, 4 feedings/day, as a reasonable upper bound for maximising muscle protein synthesis. [jissn.biomedcentral.com/articles/10.1186/s12970-018-0215-1](https://jissn.biomedcentral.com/articles/10.1186/s12970-018-0215-1).

[^3]: Volek, J.S. et al. (1997), "Testosterone and cortisol in relationship to dietary nutrients and resistance exercise," *Journal of Applied Physiology* 82(1):49–54 — diets very low in fat (≤15% of calories) correlate with lower resting testosterone in resistance-trained men. The practical takeaway adopted in evidence-based nutrition is a fat floor around 20–25% of calories, which for typical macro splits lands near 0.8–1.0 g/kg.

[^4]: Hall, K.D. et al. (2016), "Energy expenditure and body composition changes after an isocaloric ketogenic diet in overweight and obese men," *American Journal of Clinical Nutrition* 104(2):324–333 — the keto-vs-mixed-diet metabolic-ward study showing no metabolic advantage to ketosis once calories are equated. [academic.oup.com/ajcn/article/104/2/324/4564649](https://academic.oup.com/ajcn/article/104/2/324/4564649).
