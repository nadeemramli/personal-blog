---
title: Part 3.0 — Omega-3, Fiber, and the Gut
draft: false
tags:
  - health
  - nutrition
...
date: 2026-05-28
---
> [!abstract] This is **Part 3 of 5** in the [[Part 1.0 - What Nutrition Actually Is|Nutrition Series]]. Part 2 set the macros; this article is the inputs the macro tracker can't see but your blood, brain, and gut can. The full path:
> 
> - **Part 1:** [[Part 1.0 - What Nutrition Actually Is|What "Nutrition" Actually Is]]
> - **Part 2:** [[Part 2.0 - The Macros|The Macros]]
> - **Part 3 (this article):** [[Part 3.0 - Omega-3, Fiber, and the Gut|Omega-3, Fiber, and the Gut]] — DHA/EPA, the microbiome, the prebiotic bowl
> - **Part 4:** [[Part 4.0 - Calorie Management - Bulk, Cut, Reverse|Calorie Management: Bulk, Cut, Reverse]]
> - **Part 5:** [[Part 5.0 - The Weekly System|The Weekly System]]
> ----
## Table of Contents

- [Why this article exists at all](#why-this-article-exists-at-all)
- [Omega-3: DHA and EPA, and why they're not optional](#omega-3-dha-and-epa-and-why-theyre-not-optional)
- [Where to actually get DHA and EPA in Malaysia](#where-to-actually-get-dha-and-epa-in-malaysia)
- [Fiber: the macro most people undershoot by half](#fiber-the-macro-most-people-undershoot-by-half)
- [The gut: 7 strains, and why diversity is the goal](#the-gut-7-strains-and-why-diversity-is-the-goal)
- [The Prebiotic Diet Bowl (the recipe)](#the-prebiotic-diet-bowl-the-recipe)
- [A second gut-food recipe: the savoury fiber plate](#a-second-gut-food-recipe-the-savoury-fiber-plate)
...
> [!important] Why omega-3 and fiber get their own article
...
[[Part 2.0 - The Macros|Part 2]] is rigorous on calories, protein, fat-floor, and carbs. It is also, by design, *agnostic* about what fats and what carbs. You can hit 72 g of fat from butter and chicken skin. You can hit 380 g of carbs from white rice and gummy bears. The macro tracker will give you a green tick either way.
...
- **Inflammation.** EPA in particular produces resolvins and protectins — molecules that actively *resolve* inflammation rather than just opposing it. This matters for joint pain, recovery from heavy training, and the [[Part 4.0 - Protection|chronic-inflammation half of the Healthy panel]].
...
> [!tip] On the fish-oil capsule
> If you supplement, look for **EPA+DHA grams**, not "fish oil grams" — the latter is mostly fillers. A capsule labelled "1000 mg fish oil, 180 mg EPA, 120 mg DHA" gives you 300 mg of the stuff that matters. You'd need 6–7 of those for a 2 g/day target. Triglyceride-form and re-esterified-triglyceride-form (rTG) are well-absorbed; ethyl-ester is cheaper and slightly less absorbed, taken with fat. Brand-specific recommendations are in [[Part 5.0 - The Weekly System|Part 5]] alongside the rest of the iHerb stack.

> [!warning] The mercury question
...
> [!note] The fiber–protein trade-off
> A common quiet failure: lifters who eat a lot of protein crowd out fiber. Chicken breasts and protein shakes have ~0 fiber. ==You can hit 200 g of protein and end the day at 12 g of fiber, with predictable consequences for digestion and the [[Part 1.1 - Measuring Yourself|cholesterol panel]].== The fix is structural — every meal carries a fiber load — not "I'll add a fiber drink at night." Build it into the meal shape from the start.
...
| Lever | What it does | Practical move |
|---|---|---|
| **Plant diversity** | Drives microbial diversity | Aim for **30+ different plant foods per week** (count herbs, spices, nuts, seeds, all colours of vegetable) |
| **Soluble fiber** | Fermentable substrate for bacteria → butyrate | Oats, beans, lentils, fruit, inulin, psyllium |
| **Fermented foods** | Direct introduction of live cultures + bioactives | Yoghurt, kefir, kimchi, sauerkraut, miso, tempeh, kombucha (low-sugar) |
| **Polyphenols** | Selective fertilizer for beneficial strains | Berries, dark chocolate (>70%), olive oil, green tea, coffee |
| **Reduce broad-spectrum antibiotic use** | Avoid microbiome scorched-earth | Only take antibiotics when actually needed; recover deliberately after |
| **Sleep and stress** | The non-food levers; vagal tone modulates motility and microbe balance | [[Part 1.0 - The Architecture of Sleep\|See Sleep series]] |

> [!warning] The probiotic-pill question
...
The connection to [[Part 4.0 - Pharmacology|the Fit/PE series]] is real and worth flagging: the gut wall is the substrate everything else absorbs through. The [[Part 3.2 - Cycle Design|PE Cycle Design article's]] insistence on "fix digestion before you load compounds" is the same idea — a leaky, inflamed, low-diversity gut is a worse vehicle for nutrients *and* a worse vehicle for the chemistry on top of them.
...
|---|---|---|
| Greek yoghurt | 150 g | ~15 g protein, probiotic carrier, creamy base |
| Honey | 15 g | Natural sweetener, contains some prebiotic oligosaccharides |
| Cinnamon (powder) | 1.5–3 g | Polyphenol; some glucose-modulation evidence |
| Cacao powder | 5–10 g | Polyphenol-dense (flavanols); deepens flavour |
| L-glutamine | 10 g | Gut-mucosa support (modest evidence; cheap; well-tolerated) |
...
| Ingredient | Amount | Why |
|---|---|---|
| Milk (or soy milk; water works in a deficit) | 150 ml | Carrier liquid |
| Protein powder (whey/iso/soy mix) | 40 g | ~30 g protein |
| Creatine monohydrate | 5 g | The single most evidence-backed lifting supplement; daily, with food |
| Blended oats | 40 g | Beta-glucan soluble fiber; slow carbs |
| Mixed berries (blueberries, raspberries, strawberries) | 75 g | Polyphenols, fiber, fruit |
| Mixed nuts (cashew, pistachio, almond, walnut) | 20 g | Fats (incl. some omega-3 ALA from walnut), insoluble fiber |
| Inulin powder | 10 g | Prebiotic fiber; feeds Bifidobacterium specifically |
| Collagen peptides | 5 g | Joint/connective-tissue support; light evidence; cheap |
...
| Item | Amount | Why |
|---|---|---|
| Banana | 1 (yellow with a hint of green) | Resistant starch (more starch than sugar when slightly under-ripe); potassium; cheap |
...
| Item | Amount | Why |
|---|---|---|
| Psyllium husk | 10 g | Massive soluble-fiber dose; LDL-lowering evidence; bowel regularity |
| Water | 300 ml minimum | Psyllium **needs** the water |
...
| Macro / nutrient | Amount in one bowl + drink |
|---|---|
| Protein | ~50 g |
...
4. **Make the 30-plant list.** Tape a piece of paper on the fridge. Tick a different plant every time you eat it. By Sunday, count. If you're under 20, [[Part 5.0 - The Weekly System|the Part 5 grocery list]] is the fix.
...
> [!note] Up next
> Macros are set, the gut and omega-3 inputs are set. [[Part 4.0 - Calorie Management - Bulk, Cut, Reverse|Part 4.0 — Calorie Management]] is the steering article: when to bulk vs. cut vs. reverse-diet, how to pull the right lever at the right time, and how MacroFactor + your weight trend close the loop.
