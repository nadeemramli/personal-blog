---
title: Part 4.0 — Calorie Management - Bulk, Cut, Reverse
draft: false
tags:
  - health
  - nutrition
...
date: 2026-05-28
---
> [!abstract] This is **Part 4 of 5** in the [[Part 1.0 - What Nutrition Actually Is|Nutrition Series]]. Macros are set, gut and omega-3 inputs are set — this is the article about *steering*: when to add calories, when to subtract them, and how to come back without ricocheting. The full path:
> 
> - **Part 1:** [[Part 1.0 - What Nutrition Actually Is|What "Nutrition" Actually Is]]
> - **Part 2:** [[Part 2.0 - The Macros|The Macros]]
> - **Part 3:** [[Part 3.0 - Omega-3, Fiber, and the Gut|Omega-3, Fiber, and the Gut]]
> - **Part 4 (this article):** [[Part 4.0 - Calorie Management - Bulk, Cut, Reverse|Calorie Management: Bulk, Cut, Reverse]] — bulk, cut, reverse, with MacroFactor as the dashboard
> - **Part 5:** [[Part 5.0 - The Weekly System|The Weekly System]]
> ----
## Table of Contents

- [The decision tree: bulk, cut, or maintain](#the-decision-tree-bulk-cut-or-maintain)
- [The bulk: rate, composition, and when to stop](#the-bulk-rate-composition-and-when-to-stop)
- [The cut: pulling carbs and (last) fat](#the-cut-pulling-carbs-and-last-fat)
- [The reverse diet: from cut back to maintenance without ricochet](#the-reverse-diet-from-cut-back-to-maintenance-without-ricochet)
- [Reading the trend: what the weight is telling you](#reading-the-trend-what-the-weight-is-telling-you)
- [MacroFactor and the closed loop](#macrofactor-and-the-closed-loop)
...
> [!important] The single mental model for this whole article
...
[[Part 1.2 - Recomp, Cut or Bulk - How to Actually Decide|The Fit-series decision article]] is the deep dive on this — body-fat percentage, training age, and goal. The short version, restated for the nutrition context:
...
| **Lean and post-cycle ([[Part 4.5 - Coming Off and PCT\|PE Part 4.5]])** | **Maintenance, then slight deficit.** | The 80% retention rule: hold what you can, expect to lose the water/glycogen layer. Don't crash a deficit on top of HPTA recovery. |
| **Enhanced bulk block** | **Surplus.** | The point of the [[Part 5.0 - Putting It All Together\|enhanced bulk]] is to fuel growth that natural calories couldn't. Underfeeding the cycle is wasting the cycle. |
...
The enhanced lifter on a [[Part 3.2 - Cycle Design|build block]] has a different calculus. The PE-series rule applies: ==you don't waste the cycle by underfeeding it.== A typical [[Part 5.0 - Putting It All Together|enhanced bulk]] runs +500–800 kcal/day, sometimes more for the heaviest blocks. The body partitions much better in the surplus on cycle; that partitioning is what you bought the cycle for. The lever order doesn't change (protein floor first), but the carb upper end goes much higher.
...
- **Bloods.** Triglycerides climbing, fasting glucose drifting up, blood pressure inching higher — the Healthy half is paying for the Fit gains. ==This is why the bulk has a [[Part 1.1 - Measuring Yourself|biomarker cadence]] not just a scale cadence.==
...
**Composition of the cut.** [[Part 2.0 - The Macros|The lever order]] is the entire cut strategy:

1. **Protein goes UP, not down.** On a cut, push the upper end of the range (~2.2 g/kg). It protects muscle, maximises satiety, and the calories spent on protein cost you no fat-loss room because protein has the highest thermic effect of food (~25% of calories burned digesting it).[^3]
2. **Fat stays at the floor.** 0.8–0.9 g/kg, no lower. Going below the floor for weeks costs you hormone production, satiety, and fat-soluble vitamin status. ==This is the rule that keeps you out of "I cut so hard I lost my libido and my mood" territory.==
3. **Carbs come down.** Once protein is up and fat is at the floor, all remaining deficit comes from carbs. Carbs are the lever you can move the most without breaking anything structural.
4. **If carbs are already low and you're still stuck, *then* pull fat slightly.** And only slightly. The "fat below the floor" zone is a contest-prep zone, not a normal-cut zone.
...
- **Diet sauces.** Plain Greek yoghurt + lemon + herbs = tzatziki at ~50 kcal per 100 g. Mustard, hot sauce, vinegar, salsa — all near zero calories. Air-fried potato wedges with tzatziki is a real meal that costs less than most people's cut snacks. [[Part 5.0 - The Weekly System|Part 5 has the full hack list.]]
- **Coffee, tea, sparkling water.** Caloric drinks are the silent fat in a cut. Replace.

> [!tip] The "low-calorie full" goal
...
1. **Hold cut macros for one final week** at the end of the cut, *without* losing more weight. This gives the body a beat at the lowest intake before you start adding back.
2. **Add ~50–100 kcal per week**, almost entirely through carbs. Carbs first because (a) glycogen and water want to come back, (b) carbs are the cheapest calorie to add without adding fat or breaking the fat floor, (c) refilled glycogen makes training better, which raises true expenditure.
3. **Increase cardio modestly in parallel** (the Steve "eat more, cardio more" pattern). The idea is to expand the calories-in *and* the calories-out side together. Don't just dump cardio at the same time you start eating more.
4. **Weigh daily, read the 7–14 day trend.** Some weight comes back fast (water + glycogen, 1–2 kg in week one). That's not fat. Keep going.
5. **Stop adding when the trend flattens for 2–3 weeks at a calorie level you can sustain.** That's your new maintenance. Sit there for at least a month before deciding what's next.
6. **Once stable, gradually taper the extra cardio back down** to whatever your normal cardio load is. This is the second half of the "cardio more, then taper the cardio" pattern.
...
> [!warning] The myth that often kills a reverse
...
The reverse is also the right shape after the [[Part 4.5 - Coming Off and PCT|PE-series post-cycle phase]]: once SERMs are done and bloodwork is recovering, the reverse pattern back to normal maintenance is the safest way to hold muscle without piling fat on top of a still-recovering HPTA.
...
> [!tip] The number is the boss, with one important caveat
> The same framing the [[Part 4.1 - When the Numbers Move|PE-series biomarker article]] uses: the trend is the boss. But the scale by itself can't tell you whether the change is muscle, fat, water, or glycogen. ==Cross-check with the tape (weekly), the mirror (bi-weekly), and the lifts (every session) before you make a big intake change.==
...
- **Decide when to switch phases.** A two-week cut isn't enough; pick a duration before you start and hold it. [[Part 1.2 - Recomp, Cut or Bulk - How to Actually Decide|Fit Part 1.2]] is the decision article.
...
1. **Decide your current phase** (cut, recomp, slow bulk). Write it down with a target body-fat or body-weight and a calendar end date 8–12 weeks out.
2. **Set the macros** for that phase using [[Part 2.0 - The Macros|Part 2]]: protein floor, fat floor, calories direction, carbs as the flex.
3. **If you're not on MacroFactor or equivalent, start the daily weigh and 7-day rolling average** in a spreadsheet today.
4. **Take the baseline measurements** (weight, waist, photos) before the phase starts.
5. **Pre-commit to your next phase.** If you're cutting, write down the reverse-diet plan now, not on the morning you finish. ==People who plan the reverse before the cut ends keep the cut.==

> [!note] Up next
> Numbers and protocols are set. The remaining question is *operational*: how does a real Malaysian week of this actually look? [[Part 5.0 - The Weekly System|Part 5.0 — The Weekly System]] is the series finale: meal prep workflow, protein powder economics in RM, eggs and tamago and salmon at the grocery, the cut hacks (wedges + tzatziki and friends), and the full iHerb supplement stack reproduced with costs.
...
[^1]: Helms, E.R., Aragon, A.A. & Fitschen, P.J. (2014), "Evidence-based recommendations for natural bodybuilding contest preparation: nutrition and supplementation," *Journal of the International Society of Sports Nutrition* 11:20 — also discusses bulk rates; ~0.5 kg/month is the upper end of mostly-muscle gain for intermediate lifters. [jissn.biomedcentral.com/articles/10.1186/1550-2783-11-20](https://jissn.biomedcentral.com/articles/10.1186/1550-2783-11-20).
...
[^3]: Halton, T.L. & Hu, F.B. (2004), "The effects of high protein diets on thermogenesis, satiety and weight loss: a critical review," *Journal of the American College of Nutrition* 23(5):373–385 — protein has ~20–30% thermic effect of food vs. ~5–10% for carbs and ~0–3% for fat; satiety and TEF together explain most of the cut benefit of higher protein.

[^4]: MacroFactor adaptive expenditure model; see Trexler, E.T., Smith-Ryan, A.E. & Norton, L.E. (2014), "Metabolic adaptation to weight loss: implications for the athlete," *Journal of the International Society of Sports Nutrition* 11:7 — adaptive thermogenesis quantified during sustained deficit; the closed-loop model is the practical answer to this physiology.
