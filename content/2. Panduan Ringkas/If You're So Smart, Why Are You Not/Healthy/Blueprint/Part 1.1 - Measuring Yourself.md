---
title: Part 1.1 — Measuring Yourself
draft: false
tags:
  - health
  - biomarkers
...
> 	- **Part 1.1 (this article):** [[Part 1.1 - Measuring Yourself|Measuring Yourself]] (how to actually read every marker, cheaply)
> - **Part 2 — The Keystone:**
...
- [The principle: trend over snapshot](#the-principle-trend-over-snapshot)
- [The minimum viable dashboard](#the-minimum-viable-dashboard)
- [Body composition and structure](#body-composition-and-structure)
...
> [[Part 1.0 - What Healthy Actually Is|Part 1.0]] told you *what* matters and *why*. This article is the practical manual for *how*: which device, which test, which lab, what cadence, and what the number actually means once you have it. It is intentionally biased toward **cheap, repeatable, and Malaysia-available** over exotic and aspirational. ==The dashboard you check beats the dashboard you can't afford to check.==
...
| Tier | What | Approximate one-off cost | Why |
|---|---|---|---|
| **Essential (do this)** | A blood panel (every 6–12 months), an arm blood-pressure cuff, a wearable for sleep + RHR, a hand dynamometer | A few hundred RM in devices; ~RM 200–600 per panel | Covers the markers that move lifespan the most, for the price of a few dinners |
| **High-value mid-tier** | A DEXA scan once or twice a year; a CGM worn for 2 weeks once | ~RM 250–500 per DEXA; ~RM 250–400 per CGM | Body composition and personal glucose curve are very hard to fake your way to without measurement |
| **Exotic (optional)** | Epigenetic clock (DunedinPACE etc), VEGF assay, pulse-wave-velocity test, NPT device | Hundreds to thousands of RM | Diminishing returns; mostly for the curious. Skip until the basics are dialled |

> [!tip] If you only buy one thing this month
...
Grip is unreasonably informative. In the **Prospective Urban Rural Epidemiology (PURE)** cohort of ~140,000 adults, grip strength was inversely associated with all-cause and cardiovascular mortality, and a **stronger predictor than systolic blood pressure** in that data.[^3] It is a fast proxy for whole-body strength, neuromuscular health, and how well you're ageing.
...
| Device | Strengths | Limits |
|---|---|---|
| **Whoop** | Pure recovery focus; very good RHR/HRV trending; daily strain vs recovery model is genuinely useful | Subscription; no display; less polished sleep-stage estimate |
| **Apple Watch** | You probably already own it; superb data integration via Apple Health; ECG and AFib detection | Sleep tracking is decent but not best-in-class; needs charging discipline to wear at night |
| **Oura ring** | Excellent for sleep + temperature; comfortable to wear nightly | Less granular HR during exercise; subscription required for full features |
...
A rough reading guide (adults, no medication, no acute illness): under ~120/80 is optimal; persistently ≥130/80 deserves a conversation with a doctor; ≥140/90 is hypertension by most modern guidelines.[^4] ==The number you want is your *home* number, averaged over 5–7 days,== not the one-off in a clinic where white-coat effect adds 10–20 mmHg for many people.
...
- Confirm that a post-meal walk does what the literature says it does (see [[Part 3.1 - Building Systems and Breaking Bad Habits|Part 3.1]]).
...
If fertility matters to you (planned or current), the standard test is a **semen analysis**, which reports count, motility, morphology, volume, and pH against **WHO 2021 (6th-edition) reference ranges**.[^5] Available at most major Malaysian fertility/urology clinics, usually requires 2–7 days of abstinence and a same-day sample. Cost ~RM 150–300.

### Nighttime erections — the vascular early-warning marker

The marker some people confuse with fertility. **Nocturnal Penile Tumescence (NPT)** is the involuntary erections that happen during REM sleep, and ==their decline is one of the earliest functional signs of cardiovascular trouble,== because erectile tissue runs on endothelial function and adequate blood flow. Reviews repeatedly find that erectile decline often precedes a cardiovascular event by years.[^6]
...
> [!tip] Ask for your raw data, every time
...
> [!note] Up next
> You can read the dashboard. The question is where to push first. [[Part 2.0 - The One Lever|Part 2.0 — The One Lever]] is the single keystone that moves more of these numbers than anything else, and it is free.
...
[^2]: Plank, L.D. (2005), "Dual-energy X-ray absorptiometry and body composition," *Current Opinion in Clinical Nutrition and Metabolic Care* 8(3):305–309 — review of DEXA as a clinical body-composition reference standard, including precision, radiation dose, and limitations.

[^3]: Leong, D.P. et al. (2015), "Prognostic value of grip strength: findings from the Prospective Urban Rural Epidemiology (PURE) study," *The Lancet* 386(9990):266–273 — grip strength was inversely associated with all-cause and cardiovascular mortality across ~140,000 participants, a stronger predictor than systolic blood pressure in that cohort. [PubMed 25982160](https://pubmed.ncbi.nlm.nih.gov/25982160/).
...
[^5]: World Health Organization (2021), *WHO Laboratory Manual for the Examination and Processing of Human Semen* (6th edition) — reference distributions for semen volume, concentration, motility, and morphology. [WHO publication page](https://www.who.int/publications/i/item/9789240030787).
...
[^7]: Belsky, D.W. et al. (2022), "DunedinPACE, a DNA methylation biomarker of the pace of aging," *eLife* 11:e73420 — methylation clock scaled so 1.0 equals one biological year per chronological year; reported values run roughly 0.40–2.44. [elifesciences.org/articles/73420](https://elifesciences.org/articles/73420).
