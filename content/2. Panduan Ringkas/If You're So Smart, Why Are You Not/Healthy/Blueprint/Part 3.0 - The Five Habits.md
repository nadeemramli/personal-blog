---
title: Part 3.0 — The Five Habits
draft: false
tags:
  - health
  - habits
...
> 	- **Part 3.0 (this article):** [[Part 3.0 - The Five Habits|The Five Habits]] (the whole protocol in five moves)
...
> - **Part 4 — The Mind:**
> 	- **Part 4.0:** [[Part 4.0 - Mental and Emotional Wellbeing|Mental and Emotional Wellbeing]] (the software layer, folded in where it belongs)
> ----
## Table of Contents

- [The philosophy: do fewer things, not more](#the-philosophy-do-fewer-things-not-more)
- [Habit 1: Sleep](#habit-1-sleep)
- [Habit 2: Nutrition](#habit-2-nutrition)
- [Habit 3: Exercise](#habit-3-exercise)
- [Habit 4: Connection](#habit-4-connection)
- [Habit 5: Things to avoid](#habit-5-things-to-avoid)
- [The honest promise (and the friction)](#the-honest-promise-and-the-friction)
...
You already know this from [[Part 2.0 - The One Lever|Part 2.0]]: sleep is the substrate of everything. Recovery, hormones, mood, cognition, appetite, immune function, and self-control all live downstream of it. The full architecture, environment, and pharmacology of sleep is the entire [[Part 1.0 - The Architecture of Sleep|Sleep series]]; here is the Blueprint-hub summary of what "do sleep well" means as a daily habit:
...
- **The win condition is a low, stable sleeping resting heart rate** ([[Part 1.1 - Measuring Yourself|Part 1.1]]). That is the scoreboard.
- **Pharmacology is the *last* lever, not the first.** If sleep is genuinely broken, the [[Part 3.1 - The Pharmacological Reset|Sleep Part 3.1 — Pharmacological Reset]] explains how to use a 30-day bridge of DORAs or low-dose trazodone to rebuild architecture and then walk away. Most people never need this; the environment and pre-sleep protocol carry the day.

> [!tip] You almost certainly need *more* sleep, not less
...
The full system is the [[Nutrition|Nutrition note]] in this section. The habit, at the Blueprint level, is three things:

**1. Never let your in-the-moment mind make eating decisions.** The single most reliable nutrition finding is that your hungry, tired, stressed evening self will make worse choices than your calm, rested morning self. The trick is to *take the evening self out of the loop entirely* by building food **systems**: a default breakfast you don't decide on, a default lunch you don't shop for, a known dinner pattern, a stocked kitchen, a meal-prepped freezer, a default order at your usual restaurants. ==Decision in the morning; execution in the evening.== This is the whole engine of [[Part 3.1 - Building Systems and Breaking Bad Habits|Part 3.1]].
...
- **Protein:** ~1.6–2.2 g/kg body weight per day if you train (the [[Part 1.1 - What Actually Matters|Fit Part 1.1]] number). Lower if you don't, but most adults under-eat protein.
...
**3. Time your food kindly.** The [[Part 2.0 - The One Lever|RHR-before-bed]] thesis means **eating closer to bed costs you sleep,** and not by a small margin. The simplest rule that survives most lifestyles: ==**last real meal four hours before lights-out.**== Hydration earlier. Caffeine earlier. Alcohol, if at all, much earlier.

> [!warning] The Malaysian temptation, named
...
|---|---|---|
| **Strength** | 2–3 sessions/week, compound lifts | Muscle mass, bone density, glucose control, longevity. The whole [[Part 1.1 - What Actually Matters|Fit series]]. |
| **Cardio (Zone 2)** | 2–3 sessions/week, ~30–45 min | Mitochondrial density, RHR, recovery. The [[Part 2.0 - Energy Systems and the Aerobic Base|Athletic Part 2.0]] engine. |
| **Cardio (Zone 5 / VO2 max)** | 1 session/week, ~10–20 min hard | The peak of the engine; one Norwegian-4×4 a week is enough for most. |
| **Flexibility + balance** | Daily 5–10 min, plus dedicated mobility 1–2× per week | Joint longevity. The "small movements" of [[Part 3.1 - Building Systems and Breaking Bad Habits|Part 3.1]] cover much of this. |
...
> [!tip] Strength is the hidden variable in "health"
> Most people think "exercise = cardio." The data is unambiguous: **strength is at least as important.** Muscle mass is a metabolic organ. Grip strength is a longevity predictor ([[Part 1.1 - Measuring Yourself|Part 1.1]]). Strength training is what protects you from the falls and frailty that quietly kill people in old age. If you only do two things, do **two strength sessions a week**, and then walk a lot.
...
> [!note] Connection and your wearable
> A nightly call with someone you love quietly does what [[Part 2.0 - The One Lever|Part 2.0]] is trying to do: it drops your sympathetic tone before bed. Watch your RHR on those nights vs. the nights you scroll alone. It's usually visible.
...
- **Compulsive social media and doomscrolling.** Not the apps themselves; the *compulsive* version. The cost shows up in sleep (Part 2.0, action 2), in mood ([[Part 4.0 - Mental and Emotional Wellbeing|Part 4.0]]), and in the time it eats out of every other habit on this list.
- **Anything addictive, broadly.** ==Addiction makes you a prisoner.== Gambling, drugs, pornography used compulsively, food binges as coping, work as escape: the *content* varies; the *pattern* is the same and is corrosive to every other habit. The named-saboteur framework in [[Part 3.1 - Building Systems and Breaking Bad Habits|Part 3.1]] is the practical answer.

> [!tip] Why "none" beats "some"
...
- That resistance is **normal and expected**. It is the cost of building a new default, and it is exactly what [[Part 3.1 - Building Systems and Breaking Bad Habits|Part 3.1]] is about.
...
1. **Pick one habit to install this month** (probably #1 sleep, given Part 2.0). Don't try to install five at once.
2. **Write down your default breakfast, lunch, and dinner pattern** for the next month. Decide once, eat fifty times.
3. **Schedule three weekly exercise slots** in your calendar like meetings. Two strength, one cardio.
4. **Put two recurring connection events in the calendar** for the next quarter. Friend dinner, family call, group walk. They must be *recurring*, not "we should catch up sometime."
5. **Pick one thing from the avoid list to remove for 30 days** as a clean experiment, not as a forever rule. See what it does to your numbers.
6. **Decide your bright lines** explicitly: write them down, tell the people you live with, make them rules rather than preferences.

> [!note] Up next
> The five habits are easy to *describe* and hard to *install*. [[Part 3.1 - Building Systems and Breaking Bad Habits|Part 3.1]] is the engineering: how to design an environment that makes them automatic, how to fire the version of you that sabotages them, and how to make a single work-from-home day quietly compound into a year of health.
...
[^3]: Holt-Lunstad, J., Smith, T.B. & Layton, J.B. (2010), "Social Relationships and Mortality Risk: A Meta-analytic Review," *PLOS Medicine* 7(7):e1000316 — meta-analysis of 148 studies / ~308,849 participants; stronger social relationships associated with ~50% increased likelihood of survival, an effect magnitude comparable to smoking cessation. [PLOS Medicine article](https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1000316).

[^4]: Holt-Lunstad, J. et al. (2015), "Loneliness and Social Isolation as Risk Factors for Mortality: A Meta-Analytic Review," *Perspectives on Psychological Science* 10(2):227–237 — loneliness, social isolation, and living alone all carry independent mortality risk after adjustment. [SAGE article](https://journals.sagepub.com/doi/full/10.1177/1745691614568352).
