---
title: Part 3.1 — Building Systems and Breaking Bad Habits
draft: false
tags:
  - health
  - habits
...
> 	- **Part 3.1 (this article):** [[Part 3.1 - Building Systems and Breaking Bad Habits|Building Systems and Breaking Bad Habits]] (systems beat willpower)
> - **Part 4 — The Mind:**
...
- [The core principle: systems, not willpower](#the-core-principle-systems-not-willpower)
- [Breaking a bad habit: the named-saboteur method](#breaking-a-bad-habit-the-named-saboteur-method)
- [Designing the environment](#designing-the-environment)
- [The low-friction compounding stack](#the-low-friction-compounding-stack)
- [The loop back to income](#the-loop-back-to-income)
...
"I don't drink on weekdays" is easier than "I drink moderately."
"No phone in the bedroom" is easier than "less phone in the bedroom."
"No food after 8pm, ever" is easier than "less late-night snacking."
"I don't keep junk in the house" is easier than "I have small amounts and stop at one."
...
> [!warning] You will have to fire the saboteur more than once
...
- The default breakfast / lunch / dinner pattern from [[Part 3.0 - The Five Habits|Part 3.0]] means evening you doesn't decide.
...
**Sleep.**
- The whole [[Part 2.0 - The Environment|Sleep Environment article]] is environment design. Cold, dark, quiet, reserved. Build the room and the room does the work.
...
> [!tip] Why this works
> Each item, alone, is trivial. Stacked, taken seven or eight times a day, five days a week, fifty weeks a year, they are **thousands of small interventions** in your favour. ==Low friction, compounding returns. For real.== This is exactly what habit-1-through-5 in [[Part 3.0 - The Five Habits|Part 3.0]] look like when they're not "exercise time" or "meditation time" but the normal texture of a workday.
...
1. **Name your saboteur** today. Write down its three loudest scripts and the rebuttals to each. Read them out loud once.
2. **Pick your two bright lines** for the next 30 days. Write them down. Tell someone.
3. **Run a kitchen test.** Identify the food you'd rather not eat. Either remove it from the house or move it out of eye-line. Today.
4. **Move your phone out of the bedroom** tonight. Buy a separate alarm clock if you need one.
5. **Set up the Pomodoro stack tomorrow.** A 45-minute work timer; a 1–2 minute break for squats / window-look / breath / water. Run it for one workday.
6. **Schedule the next two weeks' workouts** in the calendar like meetings. Pack the bag the night before each one.
7. **Open the curtains within five minutes of waking.** This week, every day. Look at the sky.

> [!note] Up next
> The systems handle behaviour. But behaviour is downstream of how you *feel*. [[Part 4.0 - Mental and Emotional Wellbeing|Part 4.0 — Mental and Emotional Wellbeing]] is the software layer: the stress, mood, connection, and identity work that decides whether any of the systems above survive contact with a bad week.
...
[^1]: Lally, P. et al. (2010), "How are habits formed: Modelling habit formation in the real world," *European Journal of Social Psychology* 40(6):998–1009 — median time to automaticity for a new daily behaviour was **66 days** (range ~18–254), not the often-quoted "21 days." Repetition in a stable context was the strongest predictor. [Wiley article](https://onlinelibrary.wiley.com/doi/10.1002/ejsp.674).

[^2]: Bryan Johnson, "How to avoid bad habits" / Blueprint protocol (blueprint.bryanjohnson.com). The "Evening Bryan" example and the five-step persuasion-techniques-and-rebuttals method are adapted from his account. [blueprint.bryanjohnson.com](https://blueprint.bryanjohnson.com/).

[^3]: Buffey, A.J. et al. (2022), "The Acute Effects of Interrupting Prolonged Sitting Time in Adults with Standing and Light-Intensity Walking on Biomarkers of Cardiometabolic Health in Adults: A Systematic Review and Meta-analysis," *Sports Medicine* 52(8):1765–1787 — light walking breaks reduced post-meal glucose ~17%, standing breaks ~9.5%, with break lengths of 2–5 minutes. [PubMed entry / PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC9325803/).
