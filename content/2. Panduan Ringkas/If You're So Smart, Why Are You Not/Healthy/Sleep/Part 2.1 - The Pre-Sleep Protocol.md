---
title: Part 2.1 — The Pre-Sleep Protocol
draft: false
tags:
  - health
  - sleep
...
date: 2026-05-25
---
> [!abstract] This is **Part 2 of 5** in the Sleep Series — the behavioural layer that sits on top of the room you built in [[Part 2.0 - The Environment|Part 2.0]]. The full path:
> 
...
> 	- **Part 2.1 (this article):** [[Part 2.1 - The Pre-Sleep Protocol|The Pre-Sleep Protocol]] — the last four hours are the start of sleep
...
- [The thesis: sleep starts four hours early](#the-thesis-sleep-starts-four-hours-early)
- [The master control: a fixed wake time + morning light](#the-master-control-a-fixed-wake-time--morning-light)
- [Caffeine: the cutoff that matters most](#caffeine-the-cutoff-that-matters-most)
- [Alcohol: the great sleep deceiver](#alcohol-the-great-sleep-deceiver)
- [Food: the last meal and the late-workout problem](#food-the-last-meal-and-the-late-workout-problem)
- [Training and lowering your resting heart rate](#training-and-lowering-your-resting-heart-rate)
- [Light: dim the world after sunset](#light-dim-the-world-after-sunset)
- [The temperature trick: a hot shower 90 minutes out](#the-temperature-trick-a-hot-shower-90-minutes-out)
- [The wind-down: down-regulating a racing mind](#the-wind-down-down-regulating-a-racing-mind)
- [Naps, and waking at 3 AM](#naps-and-waking-at-3-am)
- [The four-hour runway](#the-four-hour-runway)
- [Part 2.1 Takeaways](#part-21-takeaways)
- [Your Protocol Task List](#your-protocol-task-list)
- [Sources & references](#sources--references)

---

> [!important] The mistake this whole article corrects
...
> [!tip] The two-ended light strategy
> [[Part 2.0 - The Environment|Part 2.0]] told you to make the night dark. This is the other end: **make the morning bright.** Bright mornings + dark evenings is the single most effective non-drug circadian intervention there is, and it's the foundation the [[Part 3.1 - The Pharmacological Reset|Part 3.1 reset]] hands back to once the drugs come off. Light is the master dial. Use both ends of it.

---
## Caffeine: the cutoff that matters most

Back to [[Part 1.0 - The Architecture of Sleep|Part 1.0]]: **adenosine** builds all day and creates the *pressure* to sleep. ==Caffeine works by blocking the adenosine receptor — it doesn't reduce your tiredness, it hides it from you.== The pressure is still there; you just can't feel it. When the caffeine clears, the accumulated adenosine floods back (the "caffeine crash").
...
> [!warning] Sedation is not sleep
> This is the exact same trap as the **Z-drugs** in [[Part 3.1 - The Pharmacological Reset|Part 3.1]]: a chemical that knocks you out is not the same as one that produces *natural architecture.* If you drink, do it earlier and lighter, and stop a few hours before bed so most of it clears. A nightcap is sabotage dressed as a remedy.
...
- **The signal to watch is your overnight resting heart rate.** This is the scoreboard from [[Part 1.0 - The Architecture of Sleep|Part 1.0]]. If you train late and your sleeping RHR is elevated (and your sleep is worse and your recovery score is down), your nervous system hasn't come down off the session. The fix isn't necessarily to stop training late — it's to **build a longer, more deliberate descent after it.**
...
> [!tip] For the lifter, this closes a loop
> The [[Part 1.0 - The Architecture of Sleep|deep-sleep GH pulse]] is your biggest natural recovery tool — and a sympathetic, jacked-up nervous system at bedtime is what blocks you from reaching the deep sleep that releases it. So the wind-down isn't "soft" self-care; for an athlete it's **recovery infrastructure.** A controlled descent tonight is a bigger GH pulse and a better session tomorrow.

---
## Light: dim the world after sunset

You blacked out the bedroom in [[Part 2.0 - The Environment|Part 2.0]]. The behavioural complement is **dimming everything in the hours before bed**, because (Part 1.0) light suppresses melatonin and tells your clock it's still daytime.
...
- **A consistent wind-down ritual.** The *sequence* matters as much as the contents — a repeated pattern (shower → dim lights → read → bed) becomes a conditioned cue for sleep, the same association principle as "bed = sleep only" from [[Part 2.0 - The Environment|Part 2.0]]. Do roughly the same things in the same order nightly.
...
> [!check] This is where most chronic insomnia actually lives
...
> - **The master control is your morning, not your night:** a **fixed wake time** (7 days a week) plus **bright morning light** sets tonight's sleep. Pair with the dark evening from [[Part 2.0 - The Environment|Part 2.0]].
...
> - **The behavioural toolkit here + Part 2.0 *is* CBT-I** — the first-line treatment for insomnia. Exhaust it before [[Part 3.0 - Natural and OTC Support|Part 3]].

## Your Protocol Task List

1. **Set one fixed wake time** for all 7 days and get **10–20 minutes of outdoor light** within an hour of it. This is the highest-leverage habit — start here.
2. **Set a caffeine cutoff** (~1–2 PM for an 11 PM bed) and hold it for two weeks. Kill late pre-workout.
3. **Define your "T-4h" line.** Decide the clock time your sleep "starts," and protect the runway after it — no intense training, no big meals, no work creeping in.
4. **Install a warm shower ~90 minutes before bed** and a **screen-free last 30–60 minutes.**
5. **Build a fixed wind-down sequence** (same order nightly) ending with slow breathing; keep a paper notebook for the brain-dump.
6. **Audit alcohol and late meals** against any 3–4 AM wake-ups.
7. **Cut naps** until your nights are solid; if you must, ≤25 min before 3 PM.

> [!note] Up next
> If — and only if — the environment ([[Part 2.0 - The Environment|2.0]]) and this protocol are genuinely dialled in and you're *still* not sleeping, *then* it's time to talk chemistry. [[Part 3.0 - Natural and OTC Support|Part 3.0]] starts where it should: the natural and over-the-counter layer — and the uncomfortable truth about melatonin.
...
[^2]: Ebrahim, I.O. et al. (2013), "Alcohol and sleep I: effects on normal sleep," *Alcoholism: Clinical and Experimental Research* 37(4):539–549 — alcohol reduces sleep-onset latency and increases early-night slow-wave sleep but suppresses REM and fragments the second half of the night, producing non-restorative sleep.

[^3]: Stutz, J., Eiholzer, R. & Spengler, C.M. (2019), "Effects of Evening Exercise on Sleep in Healthy Participants: A Systematic Review and Meta-Analysis," *Sports Medicine* 49(2):269–287 — evening exercise generally does not impair, and can improve, sleep; the exception is *vigorous* exercise ending within ~1 hour of bedtime, which can delay sleep onset and elevate heart rate.

[^4]: Haghayegh, S. et al. (2019), "Before-bedtime passive body heating by warm shower or bath to improve sleep: A systematic review and meta-analysis," *Sleep Medicine Reviews* 46:124–135 — warm water immersion (~40–42 °C) roughly 1–2 hours before bed shortened sleep-onset latency and improved sleep quality, via accelerated distal heat loss and core-temperature decline.
