...
> Product owners include [[Astragalus Root (550mg×240tab) — iHerb]], [[TUDCA (250mg×60tab) — iHerb]], [[NAC (600mg×180tab) — iHerb]], [[Silymarin Complex (300mg×360cap) — iHerb]], [[Selenium (100mcg×240tab) — iHerb]], [[Copper (Bisglycinate) (2mg×100tab) — iHerb]], [[Methyl B Complex (250mg×60tab) — iHerb]], [[Vitamin C (1000mg×60tab) — iHerb]], [[TMG (Betaine) (750mg×120tab) — iHerb]], [[Calcium D-Glucarate (500mg×120tab) — iHerb]], [[DIM (300mg×120tab) — iHerb]], [[Zinc (50mg×120tab) — iHerb]], and [[Boron (5mg×240tab) — iHerb]].
...
3. **Oral-AAS liver gate.** [[TUDCA (250mg×60tab) — iHerb]] and [[NAC (600mg×180tab) — iHerb]] belong to oral-window support, but abnormal labs or symptoms stop the oral; support products do not overrule the stop condition. [[Milk Thistle Recovery Protocol]] owns milk thistle **after** the stressor stops, not during the active oral window.
...
- Related: [[Year-Round Shield]], [[Blood Pressure & Fluid Escalation Protocol]], [[Glucose & Insulin Sensitivity Protocol]], [[Oral and Extreme Deployment Protocol]], [[PCT Support Layer Protocol]], [[Milk Thistle Recovery Protocol]]
