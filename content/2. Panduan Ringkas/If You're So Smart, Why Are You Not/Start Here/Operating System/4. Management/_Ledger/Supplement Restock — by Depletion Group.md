---
title: Supplement Restock — by Depletion Group
draft: true
type: ledger
tags: [operating-system, ledger, restock, supplements]
date: 2026-06-14
horizon_options: [2027-12-31, 2028-12-31]
---
> [!abstract] Every continuous oral (supplements + daily meds) **grouped by when it runs out**, with the restock-by date, the cash to prep, and how much to buy to last to **end-2027** or **end-2028**. Cycle PEDs and injectable peptides are excluded — they live in [[Cycle PED Restock — Decision & Buy Plan]]. Stock from each note's `stock_on_hand`; burn = `dose × days/week ÷ 7`.

> [!tip] How to use this: each group has ONE shop trip. Order **~2–4 weeks before the earliest run-out** in the group so a single basket (iHerb RM450 free-ship threshold) covers the whole cluster. Buy the **→2028** column if you want to front-load and shop less often; **→2027** if you'd rather keep cash free and re-buy next year.
...
| Bacopa Monnieri | 9 Feb 27 | 3 · RM170 | 6 · RM340 |
...
- "Restock by" = ~2–4 weeks before the earliest item in the group runs out (lets one basket cover the cluster).
- Oral Minoxidil costed at the Lazada box price (RM261.30) — switch source to drop it.
- Excludes cycle PEDs, injectables, peptides (→ [[Cycle PED Restock — Decision & Buy Plan]]) and as-needed/situational items.

## Links
- Runway: [[Stock Runway — Overall]] · PEDs: [[Cycle PED Restock — Decision & Buy Plan]]
- Restock policy: [[Restock SOP]] · Cost roll-up: [[Monthly Nut]] · [[The Operating System]]
