...
- ✅ Add a poster embed (`![[Poster — ....png]]`) at the chosen spot in the article
- ✅ Add a short description paragraph directly beneath the embed, derived from the viz concept brief
...
**Description format:**
Write 2–3 sentences. Use the viz concept brief (§1 Big Idea + §4 Copy) as the source — stay consistent with its language. The description should tell the reader *what the poster is* and *how to use it*, not summarize the article. End with a one-line utility statement (e.g., "Pin this. Come back to it each week.").
...
|---|---|---|---|---|
| [[Visualization Concept — Fit - Part 1.1 - What Actually Matters]] | `Poster — Fit - Part 1.1 - What Actually Matters.png` | `Fit/Aesthetic and Strength/Part 1.1 - What Actually Matters.md` | After the "Ultimately, this is how benchmarking…" summary paragraph that closes the Diagnostic Decision Tree section, before the "The only variable left is execution…" tool-stack paragraph. | 2026-05-27 |
| [[Visualization Concept — Fit - Part 1.2 - Recomp, Cut or Bulk]] | `Poster — Fit - Part 1.2 - Recomp, Cut or Bulk.png` | `Fit/Aesthetic and Strength/Part 1.2 - Recomp, Cut or Bulk - How to Actually Decide.md` | After the "…that's the framework" wrap-up sentence ending the "Finding maintenance calories — the 2-week lock-in" section (the deltas Recomp ±0 / Cut −500 / Lean bulk +200–300 just stated), before the `---` divider into The Fitness Forecast. | 2026-05-27 |
