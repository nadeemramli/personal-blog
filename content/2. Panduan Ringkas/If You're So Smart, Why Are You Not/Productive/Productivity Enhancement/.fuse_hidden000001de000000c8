---
title: Part 4.1 — Progressive Summarisation
draft: false
tags:
  - productive
  - productivity
...
> 	- **Part 4.1 (this article):** [[Part 4.1 - Progressive Summarization|Progressive Summarisation]] (the extension of your learning maps)
> 	- **Part 4.2:** [[Part 4.2 - The Operating System|The Operating System]] (build tools that *do*)
...
- [The problem with a saved note](#the-problem-with-a-saved-note)
- [Progressive Summarisation, the original technique](#progressive-summarisation-the-original-technique)
- [The reframe: your map is the summary](#the-reframe-your-map-is-the-summary)
- [The loop: each pass sharpens the map](#the-loop-each-pass-sharpens-the-map)
- [Why this beats re-reading](#why-this-beats-re-reading)
- [Part 4 Takeaways](#part-4-takeaways)
- [Your Summarisation Task List](#your-summarisation-task-list)
- [Sources & references](#sources--references)

---

> [!important] The problem with a saved note
> [[Part 4.0 - PARA|PARA]] told you where to *put* a note. This article is about making the note worth keeping. Because here's the trap: you highlight a whole article, save it, feel productive, and then six months later you reopen a wall of yellow text that's as much work to read as the original. ==A note you have to re-read in full has saved you nothing.== Progressive Summarisation[^ps] is the technique that turns a raw capture into something you can grasp in seconds. And for this blog, it isn't a separate practice; it's the maintenance routine for the **maps** you already build in the [[Part 2.0 - Mental Models for Learning|Learning series]].
...
> [!tip] This is the antidote to the orphan-note swamp
...
In practice it's a small, repeatable loop, and it rhymes with the [[Part 3.1 - The Self-Improving Workflow|self-improving workflow]] from Part 3:
...
> - Same shape as the [[Part 3.1 - The Self-Improving Workflow|self-improving workflow]]: write the improvement back into the durable artifact. And it doubles as a **learning rep**, unlike re-reading.

---
## Your Summarisation Task List

> [!todo] This week
> - [ ] Pick one topic you keep saving articles about. If it has no map yet, build a rough one (see [[Part 2.0 - Mental Models for Learning|the Learning series]]).
...
[^ps]: Tiago Forte, "Progressive Summarization: A Practical Technique for Designing Discoverable Notes" (Forte Labs). The layered-emphasis method (capture → bold → highlight → summary, added only on revisit) is kept and adapted here. The departure is treating the [[Part 2.0 - Mental Models for Learning|Learning-series map]] as the summary artifact, so the technique becomes progressive *map-refinement* rather than note-highlighting. The learning rationale (retrieval and reconstruction beat re-reading) is developed in [[Part 1.0 - How Learning Actually Happens|the Learning series]].
