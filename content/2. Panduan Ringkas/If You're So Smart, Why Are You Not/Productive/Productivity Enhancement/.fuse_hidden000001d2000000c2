---
title: Part 1.0 — The Productivity Stack
draft: false
tags:
  - productive
  - productivity
...
date: 2026-05-30
---
> [!abstract] This is **Part 1 of 7** in the Productivity Enhancement Series
>
> - **Part 1 — Foundation (2 sub-articles):**
> 	- **Part 1.0 (this article):** [[Part 1.0 - The Productivity Stack|The Productivity Stack]] (what productivity actually is, the six layers, and the order to build them in)
> 	- **Part 1.1:** [[Part 1.1 - The Enemy of Productivity|The Enemy of Productivity]] (the four things every layer is defending against)
> - **Part 2 — The Physical Layer:**
> 	- **Part 2.0:** [[Part 2.0 - The Machine and the Room|The Machine and the Room]] (the hardware and the environment you can't out-discipline)
> - **Part 3 — The Workflow Engine (2 sub-articles):**
> 	- **Part 3.0:** [[Part 3.0 - The Workflow Engine|The Workflow Engine]] (Capture, Clarify, Organise, Reflect, Execute, AI-supercharged)
> 	- **Part 3.1:** [[Part 3.1 - The Self-Improving Workflow|The Self-Improving Workflow]] (feedback once, the task gets permanently sharper)
> - **Part 4 — The Knowledge System (3 sub-articles):**
> 	- **Part 4.0:** [[Part 4.0 - PARA|PARA]] (organise everything you know by how soon you'll act on it)
> 	- **Part 4.1:** [[Part 4.1 - Progressive Summarization|Progressive Summarisation]] (the extension of your learning maps)
> 	- **Part 4.2:** [[Part 4.2 - The Operating System|The Operating System]] (build tools that *do*, not a brain that only stores)
> - **Part 5 — The Tactical Toolkit:**
> 	- **Part 5.0:** [[Part 5.0 - The Tactical Toolkit|The Tactical Toolkit]] (digital fluency, supercharged: inbox zero, Readwise, the anti-library, RAG)
> - **Part 6 — JIT Project Management:**
> 	- **Part 6.0:** [[Part 6.0 - Just-in-Time Project Management|Just-in-Time Project Management]] (pull a project through the system only when it's due)
> - **Part 7 — AI as a Worker (3 sub-articles):**
> 	- **Part 7.0:** [[Part 7.0 - The Agentic AI Framework|The Agentic AI Framework]] (Model → Tooling → Protocol → Agentic Layer → Context → Harness)
...
- [The thesis: you don't buy productivity, you build a stack](#the-thesis-you-dont-buy-productivity-you-build-a-stack)
- [The fundamentals didn't change; the multiplier did](#the-fundamentals-didnt-change-the-multiplier-did)
- [The stack, bottom to top](#the-stack-bottom-to-top)
- [Why "Operating System" and not "Second Brain"](#why-operating-system-and-not-second-brain)
- [Two motifs that run through everything](#two-motifs-that-run-through-everything)
- [Where habits live](#where-habits-live)
- [Part 1 Takeaways](#part-1-takeaways)
- [Your Productivity Stack Task List](#your-productivity-stack-task-list)
- [Sources & references](#sources--references)

---

> [!important] Why start with a stack and not a list of apps?
...
The **Productive** section of this blog has a clean shape, and it's the same shape as a computer. [[Part 1.0 - The Cognitive Architecture|Cognitive Enhancement]] is the **hardware**: the brain's raw processing power, focus, and recall, plus the chemistry that protects it. [[Part 1.0 - How Learning Actually Happens|Learning and Skill Acquisition]] is the **software**: the skills you install onto that hardware and the practice that compiles them. This series is the third pillar, and it's the one almost nobody treats as a discipline:
...
| Layer | The fundamental (unchanged) | The AI multiplier (new) |
|---|---|---|
| Tactical toolkit | Inbox zero, fast retrieval, shortcuts | An assistant that reads, triages, and clears the inbox on a schedule |
| Workflow | Capture → clarify → organise → execute | The assistant drafts the clarify/organise step for you |
| Knowledge | Notes you can find later | RAG: ask your 1,000-book library a question and get the passage |
| Projects | Pull the next action when it's due | An agent that does the next action while you're asleep |
...
> [!check] The six layers
> 1. **The Physical Layer — the machine and the room** ([[Part 2.0 - The Machine and the Room|Part 2.0]]). The computer, the monitors, the RAM, the desk, and the temperature of the room. The substrate everything else runs on. You cannot out-discipline a hot, cramped, single-screen setup.
> 2. **The Tactical Toolkit — digital fluency** ([[Part 5.0 - The Tactical Toolkit|Part 5.0]]). The literacy layer: keyboard shortcuts, browser, email, calendars, password management, speed reading. Unglamorous, and the highest hourly return of anything in the stack.
> 3. **The Workflow Engine — task management** ([[Part 3.0 - The Workflow Engine|Part 3.0]]). The loop that catches every commitment and moves it to done: **Capture, Clarify, Organise, Reflect, Execute.**
> 4. **The Knowledge System — PKM** ([[Part 4.0 - PARA|Part 4.0]]). Where everything you learn and reference lives so you can retrieve it on demand: PARA, Progressive Summarisation, and the tools you build on top.
> 5. **JIT Project Management** ([[Part 6.0 - Just-in-Time Project Management|Part 6.0]]). The discipline of pulling a project through the system only when it's actually due, instead of carrying forty open loops at once.
> 6. **AI as a Worker — the harness** ([[Part 7.0 - The Agentic AI Framework|Part 7.0]]). The apex: once a process is solid and documented, you hand it to an agent that runs it on a schedule, on its own machine, while you do something else.
...
> [!warning] Habits aren't a layer here, and that's deliberate
...
The most popular name for the knowledge layer is "building a second brain."[^basb] It's a memorable phrase and I'm dropping it, for one reason: ==a second brain that only *stores* things is just a nicer-looking pile.== The metaphor stops at memory. It tells you to capture and file, and then it leaves the value sitting in a vault you still have to manually dig through.

The more useful frame, and the one we used in the [[Part 4.0 - Friction and the 11 Constraints|Behavioral Change]] series, is an **operating system**: a layer that doesn't just hold state, it *runs processes*. An OS stores your files, yes, but it also schedules jobs, runs programs, and does work while you're not looking.
...
> - [ ] If your systems keep collapsing for behavioural reasons, read [[Part 1.0 - The Pursuit of Greatness|Behavioral Change Part 1]] before continuing here.

---
## Sources & references

[^forte]: Tiago Forte, "The Hierarchy of Productivity Systems" / Forte Labs productivity pyramid. The original five-tier model (digital fluency, task management, habit formation, personal knowledge management, just-in-time project management) is the basis adapted and renamed throughout this series. The roots of the task-management layer trace to David Allen, *Getting Things Done* (2001), whose capture–clarify–organise–reflect–engage loop this series renames "Execute" at the final step.
[^basb]: Tiago Forte, *Building a Second Brain* (2022). Source of the PARA method and Progressive Summarisation, both kept in this series (Part 4). The "second brain" framing itself is the one term deliberately replaced here with "Operating System."
[^antilibrary]: The "anti-library" comes from Nassim Nicholas Taleb, *The Black Swan* (2007), describing Umberto Eco's unread-books collection as a research tool rather than a trophy shelf: the value of a library is in what it lets you reach for, not in what you've already read.
