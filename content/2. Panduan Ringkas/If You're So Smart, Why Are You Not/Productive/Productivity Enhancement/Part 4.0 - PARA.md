...
> 	- **Part 4.0 (this article):** [[Part 4.0 - PARA|PARA]] (organise everything you know by how soon you'll act on it)
...
- [The knowledge layer's one job](#the-knowledge-layers-one-job)
- [Why organise by actionability, not topic](#why-organise-by-actionability-not-topic)
- [The four buckets](#the-four-buckets)
- [How things move between buckets](#how-things-move-between-buckets)
- [Running PARA in practice](#running-para-in-practice)
- [Part 4 Takeaways](#part-4-takeaways)
- [Your PARA Task List](#your-para-task-list)
- [Sources & references](#sources--references)

---

> [!important] The knowledge layer's one job
> The [[Part 3.0 - The Workflow Engine|workflow]] handles things you'll *do*. The knowledge layer handles things you'll *consult*: notes, references, research, saved articles, documents. Its one job is ==retrieval: getting the right thing back into your hands the moment you need it.== A knowledge base you can't retrieve from is just a hoard. PARA is the organising scheme that makes retrieval automatic, and it's one of the terms this series keeps from the original framework[^para] because it's genuinely the best answer to "where does this go?"
...
> [!check] P · A · R · A
> - **Projects — active, with a deadline and an outcome.** Things you're working on *now* that will end: "launch the Q3 page," "renew the lease," "write Part 4." Each maps to a project in your [[Part 6.0 - Just-in-Time Project Management|workflow]]. This is the hottest, most-touched bucket.
...
> [!tip] The same scheme everywhere
...
- **Archive aggressively.** A finished project sitting in your active space is noise (the [[Part 1.1 - The Enemy of Productivity|enemy]]). Sweeping it out is how the system stays fast.
...
[^para]: Tiago Forte, *Building a Second Brain* (2022), and "The PARA Method" (2023). PARA (Projects, Areas, Resources, Archives) is kept from the source framework because organising by actionability rather than topic is, in practice, the most reliable answer to where information should live. This series departs from the source mainly at [[Part 4.2 - The Operating System|Part 4.2]], where the "second brain" goal of storage is replaced with building tools that act.
