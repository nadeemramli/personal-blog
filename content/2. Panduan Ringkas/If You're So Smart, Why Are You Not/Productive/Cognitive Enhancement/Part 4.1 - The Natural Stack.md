---
title: Part 4.1 — The Natural Stack
draft: false
tags:
  - productive
  - cognition
...
date: 2026-05-25
---
> [!abstract] This is **Part 4 of 4** in the Cognitive Enhancement Series (the clean, natural daily engine). The full path:
>
...
- [The bio-circuit: how the natural stack connects](#the-bio-circuit-how-the-natural-stack-connects)
- [The base stack: 13 ingredients, by job](#the-base-stack-13-ingredients-by-job)
- [Dosage optimisation: getting each one right](#dosage-optimisation-getting-each-one-right)
- [The pre-made trap: one scoop forces a compromise](#the-pre-made-trap-one-scoop-forces-a-compromise)
- [Synergy and redundancy: what to add, what to skip](#synergy-and-redundancy-what-to-add-what-to-skip)
- [Timing: building the stack around your day](#timing-building-the-stack-around-your-day)
- [The two-tier operational roadmap](#the-two-tier-operational-roadmap)
- [The cost model: what the stack actually costs per month](#the-cost-model-what-the-stack-actually-costs-per-month)
- [Part 4 Takeaways](#part-4-takeaways)
- [Your Build Task List](#your-build-task-list)
...
| Ingredient | Pillar (from [[Part 1.0 - The Cognitive Architecture\|Part 1.0]]) | Act | What it does here |
|---|---|---|---|
...
| **Bacopa** | 165–330 mg | ~300 mg (50% bacosides) | **Underdosed at one serving.** Needs ~300 mg+ to work for memory.[^1] |
...
> [!check] The fixes that matter most
> 1. **The caffeine:theanine ratio.** The golden ratio is **2:1 theanine-to-caffeine** (e.g. 200 mg theanine / 100 mg caffeine).[^2] Most blends invert this. Cheapest, highest-impact tweak in the whole stack.
> 2. **Cycle the Huperzine-A** (weekdays on, weekends off); its long half-life means daily use accumulates into headaches and twitches.
> 3. **Dose fish oil by DHA, not weight:** aim for ≥500–1,000 mg actual DHA. Volume of fat doesn't matter; DHA content does.
...
The shape of the day follows the **gas-and-brakes arc** from [[Part 1.1 - Signal and Noise|Part 1.1]]: a calm *foundational* layer underneath everything, **excitation** stacked on top during your produce-windows, and **inhibition** deliberately raised in the evening to recover. Three blocks:
...
> [!danger] The sleep caveat on an evening Rhodiola
> Rhodiola keeps norepinephrine active, the exact chemical that *wakes the brain up*. A potent extract at 5:30–6 PM can leave you physically exhausted but mentally racing at 11 PM. Two defences: (1) keep the pre-workout dose **small (100–200 mg)** and rosavin-dominant; (2) ==take your L-theanine *post-workout / pre-bed*==, where it raises GABA and turns off the lingering norepinephrine push, easing you into deep sleep ([[Part 2.1 - The Pre-Sleep Protocol|Sleep series]]).
...
> [!check] The rest days protect your brain and your wallet
> Dropping the Heavy modules on your 2–3 low-intensity days does three things at once: your **caffeine tolerance resets**, your **Huperzine-A clears** (preventing headaches/twitches from accumulation), and your **Alpha-GPC and Tyrosine bottles stretch** far longer. ==You build structure every day; you only spend the stimulants when there's a result to produce.== This is the [[Part 1.0 - The Cognitive Architecture|Performance-vs-Preservation]] split turned into a weekly calendar.

> [!important] The Golden Rule of the whole stack: never max a single compound
> Notice what every dose in both tiers has in common: they're **modest.** This is the most important operating principle in stack-building, and it falls straight out of the [[Part 1.1 - Signal and Noise|inverted-U]]: ==you get a better, more flexible cognitive state from *modest amounts of several complementary inputs* than from a *maximum dose of any single one.*== Precursor (Tyrosine) + metabolic optimiser (ALCAR) + a small breakdown-inhibitor (Huperzine) + the calming balancer (Theanine), each at a sensible dose, layer into a smooth, balanced state. Megadosing any *one* of them shoves you over your peak and floods you with the jitters, crash, and tolerance that wreck long-term output. **Low-dose synergy beats max-dosing, always.** It's also why the natural stack works at all: a dozen-plus modest inputs covering every pathway will out-perform one heroic dose of a single "hero" compound every time.

---
## The cost model: what the stack actually costs per month

The same framing as the [[Part 5.1 - Cost|PE finale]]: ==the real question isn't the upfront price, it's the true monthly burn rate.== The bottles empty at wildly different rates, so the big upfront number is misleading. We'll cost the *actual* two-tier protocol, not a generic shopping list, using **Nutricost on iHerb** as the illustrative reference.
...
> [!tip] The honest cost hierarchy (same as the PE series)
> The [[Part 5.1 - Cost|PE finale]] makes the point that ==the gear is the *cheap* recurring part of a sensible protocol==: food, gym, and fast-moving consumables dominate the budget. Same here. At ~RM 285/month all-in, the stack sits roughly level with a serious food and training spend, and the biggest line items are the daily structural consumables, not the stimulants. And the highest-ROI "purchase" of all, fixing [[Part 2.0 - The Behavioral Base|sleep and your dopamine baseline]], costs nothing.
...
> - **This whole article is Tier 2.** A complete, legal, sustainable daily engine; most people never need [[Part 4.2 - The Enhanced Stack|Part 4.2]].
...
1. **Audit your intake against the dosage table.** Fix the theanine:caffeine ratio first; it's the cheapest win.
2. **Set the choline split:** low daily CDP-choline as baseline, Alpha-GPC reserved for heavy days.
3. **Lock in the dietary base:** daily fish oil (≥500 mg DHA), creatine 3–5 g, and take the fat-soluble pieces with a fatty meal.
4. **Build the two-tier calendar:** the stimulant-free Daily Baseline every day; the Heavy Execution overlay only on your 4–5 real output/training days.
5. **Add only Lion's Mane (real extract)** to start beyond the base; resist piling on. Hold Polygala/Rhodiola for a *demonstrated* ceiling.
6. **Run it as a single-variable experiment** and judge it on the [[Part 1.0 - The Cognitive Architecture|numbers]] over 3–4 weeks, then, and only then, consider whether [[Part 4.2 - The Enhanced Stack|Part 4.2]] is worth opening.

> [!note] Up next
> This is the complete natural machine. [[Part 4.2 - The Enhanced Stack|Part 4.2 — The Enhanced Stack]] takes these exact six pathways and shows what changes when you layer experimental and prescription compounds on top: racetams, peptides (Noopept, Semax, the heavily-flagged Dihexa), and the Tier-1 eugeroics/stimulants, with the honest risk accounting each one demands.
...
[^1]: Kongkeaw, C. et al. (2014), "Meta-analysis of randomized controlled trials on cognitive effects of Bacopa monnieri extract," *Journal of Ethnopharmacology* 151(1):528–535. Bacopa improves memory free recall and attention speed; effective doses standardised to bacosides ~300 mg/day, effects building over weeks. [PubMed 24252493](https://pubmed.ncbi.nlm.nih.gov/24252493/). For Rhodiola's anti-fatigue effects (with the caveat that trial quality is inconsistent), see Ishaque, S. et al. (2012), "Rhodiola rosea for physical and mental fatigue: a systematic review," *BMC Complementary and Alternative Medicine* 12:70 [PMC3541197](https://pmc.ncbi.nlm.nih.gov/articles/PMC3541197/).

[^2]: Owen, G.N. et al. (2008), "The combined effects of L-theanine and caffeine on cognitive performance and mood," *Nutritional Neuroscience* 11(4):193–198; and Giesbrecht, T. et al. (2010), *Nutritional Neuroscience* 13(6):283–290. The caffeine + L-theanine combination improves attention and reduces jitter, commonly dosed around a 2:1 theanine:caffeine ratio.

[^3]: Avgerinos, K.I. et al. (2018), "Effects of creatine supplementation on cognitive function of healthy individuals: A systematic review of randomized controlled trials," *Experimental Gerontology* 108:166–173. Creatine supports short-term memory and reasoning, with the clearest benefit under stress such as sleep deprivation; cognitive dosing 3–5 g/day. On uridine + DHA + choline synaptic membrane synthesis (Kennedy pathway), see Wurtman, R.J. et al. (2009), *Brain Research* 1264:130–140.
