...
```mermaid
flowchart TD
    P1["Part 1.0 · The Molecule<br/>what a steroid even is"] --> P2["Part 2.0 · The Factory<br/>steroidogenesis"]
    P2 --> P3["Part 3.0 · The Families<br/>5 hormone classes + the<br/>vitamin D &amp; bile-acid cousins"]
    P3 --> P4["Part 4.0 · The Messenger<br/>how steroids talk to cells"]
    P4 --> P5["Part 5.0 · The Thermostat<br/>feedback axes (HPG / HPA)"]
    P5 --> P6["Part 6.0 · Conversion &amp; Clearance<br/>aromatase, 5α-reductase, the exits"]
    P6 --> P7["Part 7.0 · Engineering the Molecule<br/>esters &amp; modifications<br/>(the bridge to the PE series)"]
```
